...
define('TEXT_MAIN', 'Please enter your email address and we\'ll send you your new password. Once you have&nbsp;&nbsp;&nbsp;<br>logged in using your new password, you may change it by going to the \'My Account\' area.');
...
define('EMAIL_PASSWORD_REMINDER_BODY', 'A new password was requested from ' . $_SERVER['REMOTE_ADDR']  . '.' . "\n\n" . 'Your new password for the \'' . STORE_NAME . '\' is:' . "\n\n" . '   %s' . "\n\nAfter you have logged in using your new password, you may change it by going to the 'My Account' area.");
