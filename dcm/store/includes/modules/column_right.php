 ...
 */
?>
<?php// require($template->get_template_dir('tpl_columnar_display_right.php',DIR_WS_TEMPLATE, $current_page_base,'templates'). '/tpl_columnar_display_right.php'); ?>
<?php include(DIR_WS_TEMPLATE.'/common/tpl_columnar_display_right.php'); ?>
