...
<h1 id="checkoutPayAddressDefaultHeading" class="bigBlue"><?php echo HEADING_TITLE; ?></h1>

<?php if ($messageStack->size('checkout_address') > 0) echo $messageStack->output('checkout_address'); ?>

<h2 id="checkoutPayAddressDefaultAddress" style="text-align:left;" class="titleBlack"><?php echo TITLE_PAYMENT_ADDRESS; ?></h2>

<address class="back" style="text-align:left;"><?php echo zen_address_label($_SESSION['customer_id'], $_SESSION['billto'], true, ' ', '<br />'); ?></address>
<div class="instructions" style="text-align:right;"><?php echo TEXT_SELECTED_PAYMENT_DESTINATION; ?></div>
<br class="clearBoth" />
