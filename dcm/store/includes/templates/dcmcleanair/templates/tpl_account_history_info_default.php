...
?>
<div id="myAccountPaymentInfo" class="floatingBox forward">
<h3><?php echo "Purchase Order Info"; ?></h3>
<div><?php echo zen_draw_separator('pixel_trans.gif', '1', '10'); ?></div>		  
<h4><?php echo ENTRY_ACCOUNT_NAME; ?></h4>
<div><?php echo $order->info['account_name']; ?></div>
<h4><?php echo ENTRY_ACCOUNT_NUMBER; ?></h4>
<div><?php echo $order->info['account_number']; ?></div>
<h4><?php echo ENTRY_PURCHASE_ORDER_NUMBER; ?></h4>
<div><?php echo $order->info['po_number']; ?></div>
<br class="clearBoth" />
</div>	  
<?php
		  // purchaseorder end
