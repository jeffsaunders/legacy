...
<!--<h1 id="reviewsWriteHeading" class="bigBlack" style="text-align:left;"><?php echo $products_name . $products_model; ?></h1>-->
<h1 id="reviewsWriteHeading" class="bigBlack" style="text-align:left;"><?php echo $products_name; ?></h1>

<h2 id="reviewsWritePrice" class="bigBlack" style="text-align:left;"><?php echo $products_price; ?></h2>

<h3 id="reviewsWriteReviewer" class="bodyBlack" style="text-align:left;"><?php echo SUB_TITLE_FROM, zen_output_string_protected($customer->fields['customers_firstname'] . ' ' . $customer->fields['customers_lastname']); ?></h3>
<br class="clearBoth" />
...
<div id="reviewsWriteProductPageLink" class="buttonRow"><?php echo '<a href="' . zen_href_link(zen_get_info_page($_GET['products_id']), zen_get_all_get_params()) . '">' . zen_image_button(BUTTON_IMAGE_GOTO_PROD_DETAILS , BUTTON_GOTO_PROD_DETAILS_ALT) . '</a>'; ?>&nbsp;&nbsp;
<?php echo '<a href="' . zen_href_link(FILENAME_REVIEWS) . '">' . zen_image_button(BUTTON_IMAGE_REVIEWS, BUTTON_REVIEWS_ALT) . '</a>'; ?>
</div>
<br class="clearBoth" />

<div id="reviewsWriteReviewsNotice" class="notice" style="text-align:left;"><?php echo TEXT_NO_HTML . (REVIEWS_APPROVAL == '1' ? ' ' . TEXT_APPROVAL_REQUIRED: ''); ?></div>
</form>
</div>
