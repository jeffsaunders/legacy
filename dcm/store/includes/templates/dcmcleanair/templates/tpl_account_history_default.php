...
<h1 id="accountHistoryDefaultHeading" class="bigBlue"><?php echo HEADING_TITLE; ?></h1>
...
<br class="clearBoth" />
    <div class="content back" style="padding: 0px 15px 0px 0px;"><?php echo '<strong>' . TEXT_ORDER_DATE . '</strong> ' . zen_date_long($history['date_purchased']) . '<br /><strong>' . $history['order_type'] . '</strong> ' . zen_output_string_protected($history['order_name']); ?></div>
