...
<h1 id="loginDefaultHeading" class="bigBlue"><?php echo HEADING_TITLE; ?></h1>
...
<div class="buttonRow back important"><?php echo '<a href="' . zen_href_link(FILENAME_PASSWORD_FORGOTTEN, '', 'SSL') . '" class="bodyBlack">' . TEXT_PASSWORD_FORGOTTEN . '</a>'; ?></div>
</form>
</fieldset>
<br class="clearBoth" />
