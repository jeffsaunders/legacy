...
<!--bof Product Name-->
<h1 id="productName" class="bigBlue" style="text-align:right;"><?php echo $products_name; ?></h1>
<!--eof Product Name-->

<!--bof Product Price block -->
<h2 id="productPrices" class="productGeneral" style="text-align:right;">
<?php
// base price
...
<div id="productDescription" class="productGeneral biggerText" style="text-align:left;"><?php echo stripslashes($products_description); ?></div>
<?php } ?>
