...
<h1 id="checkoutShipAddressDefaultHeading" class="bigBlue"><?php echo HEADING_TITLE; ?></h1>
...
<h2 id="checkoutShipAddressDefaultAddress" style="text-align:left;" class="titleBlack"><?php echo TITLE_SHIPPING_ADDRESS; ?></h2>

     <address class="back" style="text-align:left;"><?php echo zen_address_label($_SESSION['customer_id'], $_SESSION['sendto'], true, ' ', '<br />'); ?></address>
    <div class="instructions" style="text-align:right;"><?php if ($addresses_count < MAX_ADDRESS_BOOK_ENTRIES) echo TEXT_CREATE_NEW_SHIPPING_ADDRESS; ?></div>
<br class="clearBoth" />
