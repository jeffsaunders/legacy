...
class order extends base {
  ...
  function query($order_id) {
    ...
    $order_query = "select customers_id, customers_name, customers_company,
                         ...
                         coupon_code, cc_type, cc_owner, cc_number, cc_expires, currency, currency_value, account_name, account_number, po_number,
...
// purchaseorder end                       
 ...
 // purchaseorder start
                           'account_name' => (isset($GLOBALS['account_name'])?$GLOBALS['account_name']:$_POST['account_name']),
                           'account_number' => (isset($GLOBALS['account_number'])?$GLOBALS['account_number']:$_POST['account_number']),
                           'po_number' => (isset($GLOBALS['po_number'])?$GLOBALS['po_number']:$_POST['po_number']),
// purchaseorder end
