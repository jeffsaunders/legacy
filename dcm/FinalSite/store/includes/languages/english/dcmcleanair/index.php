...
//  define('TEXT_GREETING_GUEST', 'Welcome <span class="greetUser">Guest!</span> Would you like to <a href="%s">log yourself in</a>?');
  define('TEXT_GREETING_GUEST', '<span class="bigBlue">Welcome to the ' . STORE_NAME . '!</span><br><br><span class="titleBlack">Would you like to <a href="%s" class="titleBlack">log in</a>?</span>');
} else {
//  define('TEXT_GREETING_GUEST', 'Welcome, please enjoy our online showcase.');
  define('TEXT_GREETING_GUEST', '<span class="bigBlue">Welcome back to the ' . STORE_NAME . '!</span>');
}

//define('TEXT_GREETING_PERSONAL', 'Hello <span class="greetUser">%s</span>! Would you like to see our <a href="%s">newest additions</a>?');
define('TEXT_GREETING_PERSONAL', '<span class="bigBlue">Hello %s!&nbsp;&nbsp;Welcome back to the ' . STORE_NAME . '!</span>');
...
//  define('HEADING_TITLE', 'Congratulations! You have successfully installed your Zen Cart&trade; E-Commerce Solution.');
  define('HEADING_TITLE', 'Welcome to the ' . STORE_NAME . '!');
