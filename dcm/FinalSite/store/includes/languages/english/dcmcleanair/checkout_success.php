...
define('TEXT_SEE_ORDERS', 'You can view your order history by going to the <a href="' . zen_href_link(FILENAME_ACCOUNT, '', 'SSL') . '" name="linkMyAccount" class="bodyBlack">My Account</a> page and by clicking on "View All Orders".');
define('TEXT_CONTACT_STORE_OWNER', 'Please direct any questions you have to <a href="' . zen_href_link(FILENAME_CONTACT_US) . '" name="linkContactUs" class="bodyBlack">customer service</a>.');
...
define('TEXT_CHECKOUT_LOGOFF_CUSTOMER', 'Thank you for shopping. If this a shared or publically accessible computer, please click the Log Off link to ensure that your receipt and purchase information is not visible to the next person using this computer.');
