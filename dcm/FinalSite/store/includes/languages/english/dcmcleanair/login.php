...
define('HEADING_TITLE', 'Welcome to DCM Clean Air Products, Inc. Please Sign In');

define('HEADING_NEW_CUSTOMER', 'New? Please Provide Your Billing Information');
define('HEADING_NEW_CUSTOMER_SPLIT', 'New Customers');

//define('TEXT_NEW_CUSTOMER_INTRODUCTION', 'Create a customer account with <strong>' . STORE_NAME . '</strong> which allows you to shop faster, track the status of your current orders and review your previous orders.');
define('TEXT_NEW_CUSTOMER_INTRODUCTION', 'Create a customer account with <strong>DCM Clean Air</strong> which allows you to shop faster, track the status of your current orders and review your previous orders.');
...
define('TEXT_NEW_CUSTOMER_POST_INTRODUCTION_SPLIT', 'Create a Customer Account with <strong>DCM Clean Air</strong> which allows you to shop faster, track the status of your current orders, review your previous orders and take advantage of our other member\'s benefits.');
...
//define('TEXT_RETURNING_CUSTOMER_SPLIT', 'Please login to your <strong>' . STORE_NAME . '</strong> account.');
define('TEXT_RETURNING_CUSTOMER_SPLIT', 'Please login to your <strong>DCM Clean Air</strong> account.');
