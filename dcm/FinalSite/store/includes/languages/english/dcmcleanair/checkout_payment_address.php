...
define('TEXT_SELECTED_PAYMENT_DESTINATION', 'This is the current billing address. Please make sure it matches the information<br>on your credit card statement or correct it using the form below.');
