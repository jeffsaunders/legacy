...
<h1 id="checkoutPaymentHeading" class="bigBlue"><?php echo HEADING_TITLE; ?></h1>
...
<h2 id="checkoutPaymentHeadingAddress" style="text-align:left;" class="titleBlack"><?php echo TITLE_BILLING_ADDRESS; ?></h2>
...
<div class="ccinfo">
<?php
    if (defined('MODULE_PAYMENT_PO_TEXT_JS_PO_NUMBER')){
		echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;DCM accepts Purchase Orders. Please provide your PO number and a representative will contact you soon.<br>";
	}

      for ($j=0, $n2=sizeof($selection[$i]['fields']); $j<$n2; $j++) {
?>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span <?php echo (isset($selection[$i]['fields'][$j]['tag']) ? 'for="'.$selection[$i]['fields'][$j]['tag'] . '" ' : ''); ?>class="inputLabelPayment"><?php echo $selection[$i]['fields'][$j]['title']; ?></span><?php echo $selection[$i]['fields'][$j]['field']; ?>
<br class="clearBoth" />
<?php
      }
?>
...
<div class="buttonRow back"><?php echo '<strong>' . TITLE_CONTINUE_CHECKOUT_PROCEDURE . '</strong> ' . TEXT_CONTINUE_CHECKOUT_PROCEDURE; ?></div>
