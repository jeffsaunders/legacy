...
<h1 id="addressBookDefaultHeading" class="bigBlue"><?php echo HEADING_TITLE; ?></h1>
 
<?php if ($messageStack->size('addressbook') > 0) echo $messageStack->output('addressbook'); ?> 
      
<h2 id="addressBookDefaultPrimary" style="text-align:left;" class="titleBlack"><?php echo PRIMARY_ADDRESS_TITLE; ?></h2>
<address class="back" style="text-align:left;"><?php echo zen_address_label($_SESSION['customer_id'], $_SESSION['customer_default_address_id'], true, ' ', '<br />'); ?></address>
<div class="instructions" style="text-align:right;""><?php echo PRIMARY_ADDRESS_DESCRIPTION; ?></div>
<br class="clearBoth" />
...
?>
<hr><h3 class="addressBookDefaultName"><?php echo zen_output_string_protected($addresses['firstname'] . ' ' . $addresses['lastname']); ?><?php if ($addresses['address_book_id'] == $_SESSION['customer_default_address_id']) echo '&nbsp;' . PRIMARY_ADDRESS ; ?></h3>
