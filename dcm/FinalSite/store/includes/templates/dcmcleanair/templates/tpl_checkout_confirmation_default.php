...
<h1 id="checkoutConfirmDefaultHeading" class="bigBlue"><?php echo HEADING_TITLE; ?></h1>
...
<h2 id="checkoutConfirmDefaultBillingAddress" style="text-align:left;" class="titleBlack"><?php echo HEADING_BILLING_ADDRESS; ?></h2>
...
<h3 id="checkoutConfirmDefaultPayment" style="text-align:left;" class="titleBlack"><?php echo HEADING_PAYMENT_METHOD; ?></h3> 
<h4 id="checkoutConfirmDefaultPaymentTitle" style="font-weight:normal;">&nbsp;<?php echo $GLOBALS[$class]->title; ?></h4>
...
<h2 id="checkoutConfirmDefaultShippingAddress" style="text-align:left;" class="titleBlack"><?php echo HEADING_DELIVERY_ADDRESS; ?></h2>
...
?>
<h3 id="checkoutConfirmDefaultShipment" style="text-align:left;" class="titleBlack"><?php echo HEADING_SHIPPING_METHOD; ?></h3>
<h4 id="checkoutConfirmDefaultShipmentTitle" style="font-weight:normal;">&nbsp;<?php echo $order->info['shipping_method']; ?></h4>
...
<h2 id="checkoutConfirmDefaultHeadingComments" style="text-align:left;" class="titleBlack"><?php echo HEADING_ORDER_COMMENTS; ?></h2>
<div class="buttonRow forward"><?php echo  '<a href="' . zen_href_link(FILENAME_CHECKOUT_PAYMENT, '', 'SSL') . '">' . zen_image_button(BUTTON_IMAGE_EDIT_SMALL, BUTTON_EDIT_SMALL_ALT) . '</a>'; ?></div>
<div style="text-align:left;">&nbsp;&nbsp;<?php echo (empty($order->info['comments']) ? NO_COMMENTS_TEXT : nl2br(zen_output_string_protected($order->info['comments'])) . zen_draw_hidden_field('comments', $order->info['comments'])); ?></div>
<br class="clearBoth" />
<?php
//  }
?>
...
<h2 id="checkoutConfirmDefaultHeadingCart" style="text-align:left;" class="titleBlack"><?php echo HEADING_PRODUCTS; ?></h2>
...
<?php for ($i=0, $n=sizeof($order->products); $i<$n; $i++) { ?>
        <tr class="<?php echo $order->products[$i]['rowClass']; ?>">
          ...
          <td align="left" class="cartProductDisplay"><?php echo $order->products[$i]['name']; ?>
