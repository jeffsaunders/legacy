...
<!--bof Product Name-->
<h1 id="productName" class="titleBlue" style="text-align:left;"><?php echo $products_name; ?></h1>
<!--eof Product Name-->

<!--bof Product Price block -->
<h2 id="productPrices" class="titleBlack" style="text-align:left;">
<?php
// base price
...
<div id="productDescription" class="bodyBlack" style="text-align:left; padding:20px 0px 0px 20px;"><?php echo stripslashes($products_description); ?></div>
<?php } ?>
...
<!--bof Quantity Discounts table (moved up) -->
<?php
//  if ($products_discount_type != 0) { ?>
<?php
/**
...
<br><hr width="100%" size="1" noshade>
