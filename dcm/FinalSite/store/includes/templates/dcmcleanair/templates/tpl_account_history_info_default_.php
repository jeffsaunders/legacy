...
<br><div class="forward"><?php echo HEADING_ORDER_DATE . ' ' . zen_date_long($order->info['date_purchased']); ?></div>
<br class="clearBoth" />
...
<!--<caption><h2 id="orderHistoryDetailedOrder" class="titleBlack"><?php echo HEADING_TITLE . ORDER_HEADING_DIVIDER . sprintf(HEADING_ORDER_NUMBER, $_GET['order_id']); ?></h2></caption>-->
<caption><h2 id="orderHistoryDetailedOrder"><?php echo sprintf(HEADING_ORDER_NUMBER, $_GET['order_id']); ?></h2></caption>
