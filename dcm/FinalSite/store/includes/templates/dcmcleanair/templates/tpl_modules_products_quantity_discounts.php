...
<?php } else { ?>
  <table border="1" cellspacing="0" cellpadding="5" bordercolor="#808080" bordercolorlight="#C0C0C0" bordercolordark="#808080">
    <tr>
...
?>
    ...
    <tr>
      <td align="center"><?php echo $show_qty . '<br /><strong>' . $currencies->display_price($show_price, zen_get_tax_rate($products_tax_class_id)); ?></strong></td>

<?php
  foreach($quantityDiscounts as $key=>$quantityDiscount) {
?>
<td align="center"><?php echo $quantityDiscount['show_qty'] . '<br /><strong>' . $currencies->display_price($quantityDiscount['discounted_price'], zen_get_tax_rate($products_tax_class_id)); ?></strong></td>
<?php
    $disc_cnt++;
