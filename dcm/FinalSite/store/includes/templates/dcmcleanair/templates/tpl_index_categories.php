...
<?php } else { ?>
<h1 id="indexCategoriesHeading" class="bigBlue"><?php echo $breadcrumb->last(); ?></h1>
<?php } ?>
...
//    if ($current_categories_description != '') {
	 if (strlen($current_categories_description) > 6){
?>
<div id="categoryDescription" class="catDescContent" style="text-align:left;"><?php echo $current_categories_description;  ?></div>
<br><hr width="90%" size="1" noshade>
