...
?>
<div align="right"><?php echo TEXT_VISITORS_CART; ?></div>
<?php
  }
?>

<h1 align="center" class="bigBlue" id="cartDefaultHeading"><?php echo HEADING_TITLE; ?></h1>
...
<?php if (!empty($totalsDisplay)) { ?>
  <div align="center" class="cartTotalsDisplay important"><?php echo $totalsDisplay; ?></div>
  <br class="clearBoth" />
<?php } ?>
...
?>
       ...
       <td class="cartProductDisplay" align="left">
<a href="<?php echo $product['linkProductsName']; ?>" class="bodyBlack"><span id="cartImage" class="back"><?php echo $product['productsImage']; ?></span><span id="cartProdTitle" style="text-align:left;"><?php echo $product['productsName'] . '<span class="alert bold">' . $product['flagStockCheck'] . '</span>'; ?></span></a>
<br class="clearBoth" />
