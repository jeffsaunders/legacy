...
<h1 id="pageNotFoundHeading" class="bigBlue"><?php echo NAVBAR_TITLE; ?></h1>
<br>
...
<br class="clearBoth" />
<br>
<div id="tellAFriendAdvisory" class="advisory" style="text-align:left;"><?php echo EMAIL_ADVISORY_INCLUDED_WARNING . str_replace('-----', '', EMAIL_ADVISORY); ?></div>
