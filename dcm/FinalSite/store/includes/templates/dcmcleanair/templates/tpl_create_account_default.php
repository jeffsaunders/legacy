...
<h1 id="createAcctDefaultHeading" class="bigBlue"><?php echo HEADING_TITLE; ?></h1>
...
<h5 id="createAcctDefaultLoginLink" class="bodyBlack"><?php echo sprintf(TEXT_ORIGIN_LOGIN, zen_href_link(FILENAME_LOGIN, zen_get_all_get_params(array('action')), 'SSL')); ?></h5>
