...
<h1 id="checkoutShippingHeading" class="bigBlue"><?php echo HEADING_TITLE; ?></h1>
<?php if ($messageStack->size('checkout_shipping') > 0) echo $messageStack->output('checkout_shipping'); ?>
<br>
<h2 id="checkoutShippingHeadingAddress" style="text-align:left;" class="titleBlack"><?php echo TITLE_SHIPPING_ADDRESS; ?></h2>
...
<h2 id="checkoutShippingHeadingMethod" style="text-align:left;" class="titleBlack"><?php echo TABLE_HEADING_SHIPPING_METHOD; ?></h2>

<?php
    if (sizeof($quotes) > 1 && sizeof($quotes[0]) > 1) {
?>

<div id="checkoutShippingContentChoose" style="text-align:left;"><?php echo TEXT_CHOOSE_SHIPPING_METHOD; ?></div>

<?php
    } elseif ($free_shipping == false) {
?>
<div id="checkoutShippingContentChoose" style="text-align:left;"><?php echo TEXT_ENTER_SHIPPING_INFORMATION; ?></div>
