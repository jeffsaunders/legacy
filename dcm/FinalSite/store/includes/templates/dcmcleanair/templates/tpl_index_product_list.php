...
<h1 id="productListHeading" class="bigBlue"><?php echo $breadcrumb->last(); ?></h1>
...
?>
<div id="indexProductListCatDescription" class="content" style="text-align:left;"><?php echo $current_categories_description;  ?></div>
