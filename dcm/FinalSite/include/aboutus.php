...
<!-- BEGIN Include aboutus.php -->
	...
	<div id="MiddleSectionContainer" style="position:relative; top:10px; left:0px; width:1000px; background-color:#FFFFFF; z-index:1;">
		...
		<div id="RightColumnContainer" style="position:relative; top:-15px; width:750px; background-color:#FFFFFF; float:right; display:block; z-index:2;">
			...
			<!-- #BeginSnippet name="About Us" users="dcmclean" wysiwyg="no" lastsavedts="2011-08-23 01:16:53" lastsavedby="dcmclean"  --><div id="AboutUs" style="position: relative; top: 15px; left: 20px; width: 710px; z-index: 2">
<div class="bigBlue" align="center">
<p>
...
<!--				
<p>
DCM Clean-Air<sup><span size="1">TM</span></sup> Products, Inc. is the pioneer and leader in the design and manufacturing of systems for power hand tools designed for source capture of hazardous airborne dust at the &quot;POINT of GENERATION.&quot; DCM's innovative and patented designs for source capture systems provide the highest levels of breathing zone protection and ease of use for the operators. The core of our business lies in the retrofit of most brand name power tools. Source capture at &quot;POINT of GENERATION&quot; is offered with our complete line of sanders, grinders, drills, routers, scalers, power brushes, cut-off and trim saws, roto peens and our Worbst<sup><span size="1">TM</span></sup> smoke and fume extraction systems for MIG welding applications.
</p>
<p>
Our line also includes portable pneumatic and electric vacuums designed specifically for hazardous dust source capture. Our vacuums are the most powerful portable vacuums on the market and are available with or without HEPA filtration.
</p>
<p>
For those companies or individuals that have used dust collection systems before and have found them to be ineffective, cumbersome or more trouble than they are worth, we offer the following invitation. Let one of our trained technicians schedule a hands-on demonstration of our products in your facility in your working environment. We can safely say that if you do not find the DCM dust collection systems to be the easiest to use and most effective in reducing the incidence of hazardous airborne particulate then you will never be using dust collection systems as part of your work.
</p>
<p>
We are confident enough in our products to state that &quot;you have tried the rest &ndash; now try the best.&quot;
</p>
<div align="center">
<br>
<strong>
...
-->
<p>
DCM Clean-Air<sup><span style="font-size: xx-small">TM</span></sup> Products, Inc. is the pioneer and leader in the design and manufacturing of systems for power hand tools designed for source capture of hazardous airborne particulate at the &quot;point of generation&quot;.
</p>
...
<br />
<table border="0" height="24" width="328">
	<tbody>
		<tr>
