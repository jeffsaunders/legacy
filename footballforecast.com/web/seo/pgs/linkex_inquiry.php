...
Exchange Inquiry 
Form<br>
</span>Please <a href="link_exchange_details.php">click here</a> to read our 
...
<input type="hidden" name="recipient" value="web@cybermight.com" style="font-weight: 700">
<input type="hidden" name="redirect" value="form_success.php" style="font-weight: 700">
<input type="hidden" name="subject" value="Inquiry [cybermight.com]" style="font-weight: 700">
