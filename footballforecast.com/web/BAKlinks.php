...
<img border="0" src="images/spacer_content.gif" width="180" height="1"> <img border="0" src="images/transparent.gif" width="1" height="1" alt="football picks, football handicappers, NFL"> <br>
<? include('tdright.php'); ?>
</td>
