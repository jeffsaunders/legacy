	...
	<table border="0" width="160" cellspacing="1" cellpadding="0" bgcolor="#FFFFFF" id="table6">
		<tr>
			<td bgcolor="#000000" align="center" style="font-family: Verdana; font-size: 8pt; color: #FFFFFF">
...
<a href="signup.php">
<td align=center style="cursor:hand; font-family:Verdana; font-size:10pt; color:#0000FF; align=" onmouseover="this.style.background='#FFE2A9'" onmouseout="this.style.background='#000000'" bgcolor="#000000" height="69">
...
<tr>
			<td bgcolor="#000000" height="68" align="center" style="font-family: Verdana; font-size: 8pt; color: #FFFFFF">
			<a target="_blank" href="http://www.gamingbroadcast.com">
			<img border="0" src="images/gamingbroadcast_small.gif" width="160" height="68"></a></td>
		</tr>
	</table>
	</div>
<br>
