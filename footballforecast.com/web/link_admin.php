...
<table width="100%"  border="0" cellpadding="5" cellspacing="1" bgcolor="#CCCCCC" style="font-family: Arial; font-size: 10pt">
  <tr align="center" bgcolor="#EEEEEE">
    ...
    <td><strong>Reciprocal Link</strong></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  '.$link_row.'
...
';					
				...
				$link_row='<tr><td colspan="8" align="center" bgcolor="#FFFFFF" style="color: #FF0000;">No approved links in database</td></tr>';
			}
			$content='
<table width="100%"  border="0" cellpadding="5" cellspacing="1" bgcolor="#CCCCCC" style="font-family: Arial; font-size: 10pt">
  <tr align="center" bgcolor="#EEEEEE">
...
';			
		...
		case 'edit_link': {
			if(isset($_POST['name'])) {
				...
				email='".$_POST['email']."', phone='".$_POST['phone']."', reciprocal='".$_POST['reciprocal']."', active='".$_POST['status']."' WHERE id='".$_GET['link_id']."'";
				$result=mysql_query($query);
...
<div align="center" style="color: #FF0000">'.$message.'</div>
  <table width="500" border="0" align="center" cellpadding="5" cellspacing="0" style="font-family: Arial; font-size: 10pt">
    ...
    <tr>
      ...
      <td width="5" align="center">:</td>
      <td><input name="reciprocal" type="text" id="reciprocal" size="30" value="'.$data['reciprocal'].'"></td>
    </tr>
    <tr>
      <td>Link Status</td>
      <td align="center">:</td>
      ...
      <input name="id" type="hidden" id="id" value="'.$_GET['id'].'"></td>
		...
		case 'add': {
		    ...
		    if(isset($_POST['name'])) {
                ...
                url='".$_POST['url']."', category_id='".$_POST['category_id']."', admin='".$_POST['admin_name']."',
                phone='".$_POST['phone']."', email='".$_POST['email']."', active='0', reciprocal='".$_POST['reciprocal']."'";
                mysql_query($query);
                header('Location: link_admin.php?action=submitted_link');
		    }
			//get category list
...
<form name="form1" method="post" action="?action=add">
  <table width="500" border="0" align="center" cellpadding="5" cellspacing="0" style="font-family: Arial; font-size: 10pt">
    ...
    <tr>
      <td>Reciprocal URL</td>
      <td width="5" align="center">:</td>
      <td><input name="reciprocal" type="text" id="reciprocal" size="30"></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td align="center">&nbsp;</td>
