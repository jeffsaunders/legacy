...
<table width="500" border="0" align="center" cellpadding="5" cellspacing="1" bgcolor="#CCCCCC">
  <tr>
    <td style="font-family:Arial; font-size:14pt; font-weight:bold" align="center" bgcolor="#FFFFFF">FOOTBALL FORECAST WEEKLY TELEVISON SHOW</td>
  </tr>
  <tr>
    <td style="font-family:Arial; font-size:10pt; font-weight:bold" align="center" bgcolor="#FFFFFF">This is the FREE weekly television show video. You can always see past shows using the ARCHIVES link on the menu.</td>
  </tr>
  <tr>
...
document.write('TYPE="application/x-oleobject" width="400" height="370"> '); 
document.write('<PARAM NAME="url" VALUE="multimedia/weekly.wmv">'); 
...
document.write('type="application/x-oleobject" background="white" color="white" bgcolor="white" width="400" height="370">'); 
document.write('<param name="FileName" value="multimedia/weekly.wmv">'); //Clip or meta file to play 
...
document.write(' filename="multimedia/weekly.wmv"'); 
