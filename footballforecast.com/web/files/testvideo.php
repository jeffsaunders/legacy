<SCRIPT LANGUAGE="JavaScript">
	...
	if(WMP7){
		...
		document.write('<PARAM NAME="url" VALUE="mov/FFW.wmv">');
	...
	// Windows Media Player 6
		...
		document.write('<param name="FileName" value="mov/FFW.wmv">');  //Clip or meta file to play
		...
		document.write('        filename="mov/FFW.wmv"');
