	...
	if(WMP7){
		...
		document.write('<PARAM NAME="url" VALUE="http://www.footballforecast.com/mov/gaming_broadcast_collage.wmv">');
	...
	// Windows Media Player 6
		...
		document.write('<param name="FileName" value="http://www.footballforecast.com/mov/gaming_broadcast_collage.wmv">');  //Clip or meta file to play
		...
		document.write('        pluginspage="http://www.micros`oft.com/windows/windowsmedia/"');
		document.write('        filename="http://www.footballforecast.com/mov/gaming_broadcast_collage.wmv"');
