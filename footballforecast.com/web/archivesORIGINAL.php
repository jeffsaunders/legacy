...
if(!isset($_SESSION['login_id'])) {
	header('Location: login.php?url=archives.php');
	die();
}
//get latest clip from database
$query="SELECT * FROM movie WHERE status='archive' ORDER BY id DESC LIMIT 0,1";
...
<table width="500" border="0" align="center" cellpadding="5" cellspacing="1" bgcolor="#CCCCCC">
  ...
  <tr>
    <td style="font-family:Arial; font-size:10pt; font-weight:bold" align="left" bgcolor="#FFFFFF"><?php echo $data['description']; ?></td>
  </tr>
  <tr>
...
<table width="500" border="0" align="center" cellpadding="5" cellspacing="1" bgcolor="#CCCCCC">
  <tr>
    <td style="font-family:Arial; font-size:14pt; font-weight:bold" align="center" bgcolor="#FFFFFF">20 Years of Football Forcast TV Shows</td>
  </tr>
  <tr>
