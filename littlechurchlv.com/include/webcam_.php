...
<script>//alert('<?=$_REQUEST['task'];?>');</script>
...
//							document.video2.SetFullScreen();
					...
					<td width="340" rowspan="3" align="center" valign="top">
						...
						$waspID = time();
						?>
						<!-- Placeholder to display if player fails to load -->
<!--						<div id="waspTarget<?=$waspID?>" class="bodyBlack">Flash Player Plug-in Required<br><a href="http://www.adobe.com/products/flashplayer/" class="bodyBlack">Click Here for Free Installation</a></div>-->
						...
						// <![CDATA[
							...
							waspConfigs<?=$waspID?>.im="/images/WebcamSlate.jpg";
							...
							waspConfigs<?=$waspID?>.pw="320";
							waspConfigs<?=$waspID?>.ph="264"; //24px for controls
...
<? } ?>
							<br><br><strong>&mdash; Now Showing &mdash;</strong><br><img src="images/spacer.gif" alt="" width="1" height="5" border="0"><br>

<!-- Put something here to the affect "If you are encountering any problems with the video player, click here to upgrade to the latest flash player free", with a link -->
...
//									for($counter = $lastday*2; $counter >= 0; $counter--){
						...
						<tr>
							...
							<td><input type="text" name="groom" id="groom" style="width:220px;background-color:#F8F8F8;" value="<? echo stripslashes($groom); ?>"></td>
						</tr>
						<tr>
							<td><label for="bride"><strong class="bigBlack">Bride's Maiden Name:</strong></label></td>
							<td><input type="text" name="bride" id="bride" style="width:220px;background-color:#F8F8F8;" value="<? echo stripslashes($bride); ?>"></td>
						</tr>
						<tr>
				...
				<tr>
					<td valign="top">
						...
						<tr>
							...
							<td><a href="javascript:void(0)" onClick="getSample.task.value = 'stock/SampleWedding.flv'; document.getElementById('getSample').submit();" class="bodyBlack"><strong>Sample Wedding Video</strong></a></td>
							<td><img src="images/spacer.gif" alt="" width="20" height="1" border="0"></td>
							<td><img src="images/VideoIcon.gif" alt="" width="39" height="35 border="0"></td>
							<td><a href="javascript:void(0)" onClick="getSample.task.value = 'stock/ElvisWedding.flv'; document.getElementById('getSample').submit();" class="bodyBlack"><strong>Sample "Elvis" Wedding</strong></a></td>
						</tr>
						<tr>
							<td><img src="images/VideoIcon.gif" alt="" width="39" height="35 border="0"></td>
							<td><a href="javascript:void(0)" onClick="getSample.task.value = 'stock/SampleRenewal.flv'; document.getElementById('getSample').submit();" class="bodyBlack"><strong>Sample Vow Renewal</strong></a></td>
							<td><img src="images/spacer.gif" alt="" width="20" height="1" border="0"></td>
							<td><img src="images/VideoIcon.gif" alt="" width="39" height="35 border="0"></td>
							<td><a href="javascript:void(0)" onClick="getSample.task.value = 'stock/ElvisRenewal.flv'; document.getElementById('getSample').submit();" class="bodyBlack"><strong>Sample "Elvis" Renewal</strong></a></td>
						</tr>
						<tr>
							<td><img src="images/VideoIcon.gif" alt="" width="39" height="35 border="0"></td>
							<td colspan="4"><a href="javascript:void(0)" onClick="getSample.task.value = 'stock/HistoryOfTheLittleChurch.flv'; document.getElementById('getSample').submit();" class="bodyBlack"><strong>Little Church of the West Chapel History Video</strong></a> <strong class="smallBlack">(5 Minutes Long)</strong></td>
						</tr>
						</table>
					</td>
				</tr>
...
*/
//					echo '
//					<br><strong class="bigBlack">The '.ucwords($groom).'-'.ucwords($bride).' Wedding from '.date("F j",$timestamp).' has been retrieved.<!--<br>If it does not start automatically, press the play button ( <a href="javascript:document.video.DoPlay()"><img src="images/realplaybutton.gif" alt="" border="0" align="bottom"></a> ) to begin.--></strong>
//					';
//				}else{
//					echo '
