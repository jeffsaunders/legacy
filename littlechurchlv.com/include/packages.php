			...
			if ($feature == "weddings"){$type = "Wedding"; $title = "Wedding"; $promos = $config2["package_promotions"];}
			if ($feature == "renewals"){$type = "Renewal"; $title = "Vow Renewal"; $promos = $config2["renewal_promotions"];}
			if ($feature == "featured"){$type = "Featured"; $title = "Featured"; $promos = $config2["featured_promotions"];}
