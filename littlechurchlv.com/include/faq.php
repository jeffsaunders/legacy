						...
						<td background="images/225WhiteBGMiddle.gif">
							...
							<tr>
								<td>
									...
									<tr>
										<td>
											<img src='TextIMG.php?text=<?=substr($config2["questions_intro"],0,1);?>&font=CACCHAMP.TTF&bold=no&points=30&txtcolor=000000&shadow=C0C0C0&offset=2&width=40&height=30&left=0&top=25&angle=0&bgcolor=F8F6E8&transparent=yes&dropcap=yes&format=png' alt="<?=substr($config2["questions_intro"],0,1);?>" border="0">
										</td>
									</tr>
									</table>
									<?=substr($config2["questions_intro"],1);?>
								</td>
							</tr>
							</table>
						</td>
								...
								<td>
									...
									<tr>
										<td colspan="3" class="bodyDarkGray">
											<img src='TextIMG.php?text=<?=$config2["questions_title"];?>&font=CACCHAMP.TTF&bold=no&points=30&txtcolor=000000&shadow=C0C0C0&offset=2&width=450&height=39&left=0&top=25&angle=0&bgcolor=F8F6E8&transparent=yes&dropcap=yes&format=png' alt="<?=$config2["questions_title"];?>" border="0"><br><br>
										</td>
									</tr>
									<tr>
										<td colspan="3" class="bodyDarkGray">
...
//echo $query;
											$rs_faq = mysql_query($query, $linkID) or die(mysql_error());
											for ($faqCounter=1; $faqCounter <= mysql_num_rows($rs_faq); $faqCounter++){
												$faq = mysql_fetch_assoc($rs_faq);
												if ($faqCounter == 1){
											?>
											<table width="25" border="0" align="right" cellpadding="0" cellspacing="0">
											<tr>
												<td align="right"><img src="images/spacer.gif" alt="" width="25" height="100" border="o"></td>
											</tr>
											</table>
											<?
												}
											?>
											<li><strong class="bigDarkGray"><?=$faq["question"];?></strong><br>
											<?=$faq["answer"];?><br>
											<?
												if ($faqCounter <= mysql_num_rows($rs_faq)){
											?>
											...
											?>
											<br><strong class="bigDarkGray">Policies and pricing are subject to change without notice.</strong>
<!--											</ul>-->
										</td>
									</tr>
									<tr>
