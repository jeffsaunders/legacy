...
/*					// Captcha - answer defined in index.php
						if (theForm.captcha.value != <?=$answer;?>){
							...
							theForm.captcha.style.background="#FFFFFF";
...
*/					// Message
					...
					<form action="dbupdate.php" method="post" name="<?=iif($formName == "contactDiv", $formName, "contactForm");?>" id="<?=iif($formName == "contactDiv", $formName, "contactForm");?>" onSubmit="return validateContact(this);">
					<table width="225" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td background="images/225BurgundyBGTop.png"><img src="images/spacer.gif" alt="" width="225" height="20" border="0"></td>
					</tr>
					<?
					if ($formName == "contactDiv"){
					?>
					<tr>
						<td background="images/225BurgundyBGMiddle.png">
							<table width="225" border="0" cellspacing="0" cellpadding="0" align="center">
							<tr>
								<td width="180" align="right">
									<img src='TextIMG.php?text=Contact Us&font=CACCHAMP.TTF&bold=extra&points=30&txtcolor=FFFFFF&shadow=000000&offset=2&width=165&height=30&left=0&top=25&angle=0&bgcolor=770025&transparent=yes&dropcap=yes&format=png' alt="For More Information" border="0">
								</td>
								<td width="30" align="right" valign="top">
									<a href="javascript:void(0)" onclick="hide('contactLayer')" class="smallIvory"><img src="images/CloseButton.gif" alt="Close" title="Close" width="25" height="24" border="0"><br>Close<br></a>
								</td>
								<td width="15"><img src="images/spacer.gif" alt="" width="15" height="20" border="0"></td>
							</tr>
							</table>
						</td>
					</tr>
					...
					?>
					<tr>
						<td align="center" background="images/225BurgundyBGMiddle.png">
							<img src='TextIMG.php?text=Contact Us&font=CACCHAMP.TTF&bold=yes&points=30&txtcolor=FFFFFF&shadow=000000&offset=1&width=200&height=30&left=0&top=25&angle=0&bgcolor=770025&transparent=yes&dropcap=yes&format=png' alt="For More Information" border="0">
						</td>
					</tr>
					<?
					}
					...
					<tr>
						<td align="center" background="images/225BurgundyBGMiddle.png">
							...
							<strong class="xbigIvory">702.739.7971</strong>
							...
							<tr>
								<td><br><textarea cols="10" rows="3" name="message" class="bigBlack" style="width:200px; color:#3F3F3F; font-weight:bold; background-color:#FFFFFF;"></textarea><br><label for="message"><strong class="bigIvory">Your Message</strong></label></td>
							</tr>
<!--							<tr>
								<td>
									<br>
									<!-- Captcha - variables defined in index.php --
									<table width="200" border="0" cellspacing="0" cellpadding="0">
									<tr>
										<td><img src='captcha.php?width=110&height=25&stm=<?//=$lString1;?><?//=$letter1;?><?//=$rString1;?><?//=$lString2;?><?//=$letter2;?><?//=$rString2;?>'></td>
										<td align="right"><input type="text" name="captcha" id="captcha" style="width:75px; color:#3F3F3F; font-weight:bold; background-color:#FFFFFF;" value=""></td>
									</tr>
									</table>
								</td>
							</tr>-->
					...
					<tr>
						<td background="images/225BurgundyBGBottom.png"><img src="images/spacer.gif" alt="" width="225" height="20" border="0"></td>
					</tr>
					</table>
					</form>
