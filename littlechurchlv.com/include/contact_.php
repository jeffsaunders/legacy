...
<tr>
	<td align="center" background="images/900IvoryBGMiddle.gif">
	...
	<td valign="top" class="bodyBlack">
		...
		<tr>
			<td colspan="3" class="bigBlack">
				...
				<tr>
<!--					<td align="right"><img src="images/Contact.jpg" alt="" width="320" height="214" border="1"><img src="images/spacer.gif" alt="" width="20" height="1" border="0"></td>-->
					<td align="right"><img src="images/Contact2.jpg" alt="" width="300" height="300" border="1"><img src="images/spacer.gif" alt="" width="30" height="1" border="0"></td>
				</tr>
				</table>
				<img src="images/spacer.gif" alt="" width="10" height="1" border="0">
				<!-- Text -->
				<strong class="xbigBlack">Contact Us</strong><br><br>
				<p>
					<ul><ul>
					<strong>
					<span class="xbigBlack">The Little Church of the West<br></span>
					4617 Las Vegas Boulevard South<br>
					Las Vegas, Nevada &nbsp;89119<br><br>
					800.821.2452 (Toll-Free Outside Nevada)<br>
					702.739.7971 (Inside Nevada &amp; International)<br>
					702.739.8950 (Fax)<br><br>
					Open 8:00 AM to Midnight Pacific Time, Daily
					</strong>
					</ul></ul>
				</p>
				<br>
...
//				}
			...
			<?
			// Passed validation, so send it
			if ($task == "submit"){
				// Assign values
				if ($_REQUEST['type'] == "Photos"){
					$to = 'photos@littlechurchlv.com';
				}else{
...
//echo $query.'<br></br>';
			...
			?>
				<p><strong class="xbigBlack">Email Form</strong></p>
				<form action="" method="post" name="contact" id="contact" onSubmit="return validateContact(this);">
				...
				<tr>
					...
					<td>
						<select name="type" id="type" class="bigBlack" style="background-color:#ECEADC; width:238px;" tabindex="3">
							...
							<option value="Photos" <? echo iif($task == "photos", "selected", ""); ?>>Photo Lab</option>
							<option value="Flowers" <? echo iif($task == "flowers", "selected", ""); ?>>Flower Shop</option>
