...
<head>
	...
	function verify_delete(filename, sort){
		...
		if (do_it == true){
			window.location="deletereal.php?filename="+filename+"&sort="+sort;
		}
	}
	</script>
...
<tr>
	<td>
		...
		<tr>
			<td colspan="7" align="center"><strong><font size="+2">Little Church of the West Real Video Webcam File Management Console</font><br><font size="+1">- Available Weddings File List -</font></strong></td>
		</tr>
		<tr>
			<td colspan="7">
				<table border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td width="150">&nbsp;&nbsp;<a href="index.php"><strong>Main Menu</strong></a></td>
...
foreach ($files as $val) {
	echo '
		<tr bgcolor="#C0C0C0">
			...
			<td align="center">
				&nbsp;
				<a href="editreal.php?date='.$val[1].'&time='.$val[6].'&groom='.$val[3].'&bride='.$val[4].'&filename='.$val[0].'&sort='.$sort.'">Edit</a>
				&nbsp;&nbsp;&nbsp;
