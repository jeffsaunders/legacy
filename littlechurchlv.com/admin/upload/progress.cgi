...
sub make_progress_bar
{
	...
	<body bgcolor="#E0E0E0">
		<table align="center" border=0 width="100%">
		  <tr><TD align="center" bgcolor="#C0C0C0"><font size="+1">File Upload In Progress</font></td></tr>
		  <tr><td>
	        <table border=0 width='100%'>
			  <tr><td>
			   <table border=0 width='$percent%' bgcolor='red'>
 			    <tr><td width='100%' style="height: 10px"> </td></tr>
		       </table>
			  </td></tr>
		     </table>
		   </td></tr>
		   <tr>
			 <td align="center">
				<table>
				<tr><td colspan="2">
					<strong>Status:</strong> $bRead bytes of $iTotal sent (at $bSpeedf Kbps)<br />
				</td></tr>
				<tr><td><strong>Est time left:</strong> $dtRemainingf<br /></td>
				    <td><strong>Elapsed time:</strong> $dtelapsedf<br /></td>
				</tr>
				</table>
				</td>
			</tr>
		...
		<body  bgcolor="#eeeeee">
		  <table align="center">
		   <tr><td align="center">File Upload Complete</td></tr>
			<tr>
				<td>
					Status: $bRead bytes of $iTotal sent (at $bSpeedf Kbps)<br />
					Est time left: 00:00:00<br />
					Elapsed time: $dtelapsedf<br />
				</td>
			</tr>
