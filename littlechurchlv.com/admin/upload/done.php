...
//	$result = mysql_query($query, $linkID);
	// Move/Save File
	rename($tmp_name['name'][0], '/var/www/html/littlechurchlv.com/httpdocs/admin/upload/files/'. $filename);
//        move_uploaded_file($tmp_name['name'][0], '/var/www/html/littlechurchlv.com/httpdocs/admin/upload/files/'.$filename);
