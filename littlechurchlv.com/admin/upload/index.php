...
<html>
<head>
	<title>Little Church of the West File Upload Page</title>
...
<tr>
	...
	<input type="hidden" name="redirect" value="http://www.littlechurchlv.com/admin/upload/done.php"> <!-- Where to go after upload -->
...
<tr>
	<td colspan="2" align="center" bgcolor="#C0C0C0"><font size="-1"><strong>* File uploads can take time. &nbsp;Press "<em>Upload</em>" only once and please be patient.</strong></font></td>
</tr>
</table>

<br>
<div align="center"><a href="../index.php"><strong>Return to Main Menu</strong></a></div>
<br>
