...
//echo $query."<br><br>";
					...
					<tr>
						...
						<td width="140" rowspan="3" valign="top">
							<a href="javascript:void(0);" onClick="toggleDetails('<?=$divCnt;?>-<?=$productCnt;?>');"><img src="images/products/<?=$product["image1"];?>" alt="<?=$product["model"];?>" width="140" border="0" class="imageBorder"></a>
						</td>
							...
							<div id="detailsContainer<?=$divCnt;?>-<?=$productCnt;?>" class="detailsContainer" style="display:none; visibility:hidden;">
								...
								<tr>
									<td width="325" valign="top">
										...
										<tr>
											...
											?>
												...
												<a onClick="document.getElementById('image<?=$divCnt;?>-<?=$productCnt;?>').src='images/products/<?=$product["image".$thumbCounter];?>'; document.getElementById('caption<?=$divCnt;?>-<?=$productCnt;?>').innerHTML='<?=htmlentities($product["label".$thumbCounter]);?>';" class="detailsThumbnail"><img src="images/products/<?=$product["image".$thumbCounter];?>" alt="<?=$product["model"];?> Thumbnail <?=$thumbCounter;?>" title="Click to View Enlarged" width="140" border="0" class="imageBorder"></a><br><?=$product["label".$thumbCounter];?>
											<?
											}
											?>
											</td>
									...
									<td width="550" align="center" valign="top">
										...
										<img name="image<?=$divCnt;?>-<?=$productCnt;?>" id="image<?=$divCnt;?>-<?=$productCnt;?>" src="images/products/<?=$product["image1"];?>" alt="<?=$product["model"];?>" width="540" border="0" class="imageBorder"><br><span id="caption<?=$divCnt;?>-<?=$productCnt;?>"><?=$product["label1"];?></span>
									</td>
								</tr>
								</table>
								<br>
									...
									<td width="875" align="center" valign="top" class="galleryContainer">
										...
										?>
											<td width="150" valign="top">
												...
												<a href="images/gallery/<?=$galleryImage["image"];?>" class="lightview" rel="set[mygallery<?=$divCnt;?>-<?=$productCnt;?>][image]" title="<?=iif($galleryImage["description"] != "", $galleryImage["description"]." :: :: ", ":: ::");?>"><img src="images/gallery/<?=$galleryImage["image"];?>" alt="" title="Click to View Enlarged" width="150" border="0"></a>
												</div>
											</td>
										<?
										}
...
//echo $query."<br><br>";
										...
										<tr>
											<!-- Column Headers -->
											<td width="150" class="detailsColumnHeader">Types</td>
											<td width="150" class="detailsColumnHeader">Sizes</td>
											<td width="150" class="detailsColumnHeader">Thicknesses</td>
										</tr>
										<tr>
										...
										<tr>
											...
											if ($product["finishes"] != ""){
											?>
											<td width="150" class="detailsColumnHeader">Finishes</td>
											<?
											}
											if ($product["edges"] != ""){
											?>
											<td width="150" class="detailsColumnHeader">Edges</td>
											<?
											}
											...
											if ($product["colors"] != ""){
											?>
											<td width="150" class="detailsColumnHeader">Colors/Styles</td>
											<?
											}
