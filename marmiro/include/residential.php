<!-- BEGIN Include residential.php -->

			<div id="productTabsContainer">
				<strong class="sectionLabel">Residential</strong>
			</div>
...
//echo $query."<br><br>";
							...
							<tr>
								<td width="920" align="center" valign="top" class="galleryContainer">
									<br>
									<strong class="sectionLabel">Image Gallery of Some Residential Installations</strong>
									...
									<td width="150" valign="top">
										<div class="locationGalleryThumbnail">
											...
											<a href="images/locations/<?=$galleryImage["image"];?>" class="lightview" rel="set[mygallery-residential][image]" title="<?=iif($galleryImage["description"] != "", $galleryImage["description"]." :: :: ", ":: ::");?>"><img src="ResizeImage.php?image=images/locations/<?=$galleryImage["image"];?>&amp;width=150&amp;height=1000&amp;format=jpg" alt="" title="Click to View Enlarged" border="0"><!--<img src="images/locations/<?=$galleryImage["image"];?>" alt="" title="Click to View Enlarged" width="150" border="0">--></a>
										</div>
									</td>
									<?
									}
