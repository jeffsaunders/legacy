...
-->
			...
			<div id="productInfoContainer">
				...
				<div id="infoContainer1" class="infoContainer" style="<?=iif($tabCnt == 1, "display:block; visibility:visible;", "display:none; visibility:hidden;");?>">
					...
					<tr>
						<td>
							<!-- #BeginSnippet name="install-guidelines" users="marmiroc" wysiwyg="yes" -->
							...
							<tr>
								<td width="325" valign="top">
									...
									<tr>
										...
										<td width="20"></td>
										<td width="140" align="center" valign="top">
											<a onClick="document.getElementById('image').src='images/documents/090608.jpg'" class="detailsThumbnail"><img src="images/documents/090608.jpg" alt="090608.jpgú" title="Click to View Enlarged" width="140" border="0" class="imageBorder"></a><br>Page 2
										</td>
										<td width="25"></td>
									</tr>
									<tr>
