	...
	<td colspan="2" bgcolor="#FFFFFF" style="border-left: 1px solid <? echo $border_color; ?>; border-right: 1px solid <? echo $border_color; ?>;">
		...
		<tr>
			...
			<td class="bodyBlack">
				...
				<br>
				If you wish to print a confirmation now, <a href="https://secure.nr.net/datasite/receipt.php?sid=<? echo $SID; ?>" target="_blank" class="bodyBlack">Click Here</a>.<br>
				<br>
				If you have any questions about your order, please call 877.351.1658 or email us at <a href="mailto:support@deviceport.com" class="bodyBlack">support@deviceport.com</a>.</strong>
			</td>
			<td width="20"><img src="images/spacer.gif" alt="" width="20" height="1" border="0"></td>
		</tr>
		</table>
