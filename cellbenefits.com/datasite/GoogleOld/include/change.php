...
<tr>
	...
	<td><input type="checkbox" name="change_plan" id="change_plan" onClick="enablePlans(this.form);" value="T" checked>&nbsp;Change my calling plan.</td>
</tr>
<tr>
...
<tr>
	<td colspan="3">
		...
		<table width="600" border="0" cellspacing="1" cellpadding="0" align="center" class="bodyBlack">
		<tr>
			<td width="250" align="right" valign="top"><img src="images/spacer.gif" alt="" width="1" height="2" border="0"><br>BlackBerry Data ($39.99):</td>
			<td width="10" rowspan="99"><img src="images/spacer.gif" alt="" width="10" height="5" border="0"></td>
			<td width="340">
