...
<div id="Container" style="position:static; visibility:visible; display:block;">
	...
	<tr>
		<td colspan="3" align="center" class="bigBlack">
			...
			<strong><font size="+5">LIVE!</font></strong><br>
	...
	<form name="newPhone" id="newPhone" method="POST" action="saveit.php" onSubmit="return validate(this);">
		<table width="775" border="0" cellspacing="5" cellpadding="0" align="center" class="bodyBlack">
		<tr>
...
<!--						<option value="S"<? if ($copy['phone_type']=="S") echo " Selected" ?>>Smartphone</option>-->
		...
		<div id="AT&TService" style="position:relative; visibility:hidden; display:none;">
			...
			<tr>
				<td colspan="2">AT&T Mobile Backup Capable:</td>
				<td>
					<input type="radio" name="at&t_mobile_backup" value="T"<? if ($copy['at&t_mobile_backup']=="T") echo " checked" ?>> Yes
					<input type="radio" name="at&t_mobile_backup" value="F"<? if ($copy['at&t_mobile_backup']=="" || $copy['at&t_mobile_backup']=="F") echo " checked" ?>> No
				</td>
			</tr>
			<tr>
				<td colspan="2">AT&T Smart Limits Capable:</td>
				<td>
					<input type="radio" name="at&t_smart_limits" value="T"<? if ($copy['at&t_smart_limits']=="T") echo " checked" ?>> Yes
					<input type="radio" name="at&t_smart_limits" value="F"<? if ($copy['at&t_smart_limits']=="" || $copy['at&t_smart_limits']=="F") echo " checked" ?>> No
				</td>
			</tr>
			<tr>
				<td colspan="2">AT&T Mobile TV Basic Capable:</td>
				<td>
					<input type="radio" name="at&t_mobile_tv_basic" value="T"<? if ($copy['at&t_mobile_tv_basic']=="T") echo " checked" ?>> Yes
					<input type="radio" name="at&t_mobile_tv_basic" value="F"<? if ($copy['at&t_mobile_tv_basic']=="" || $copy['at&t_mobile_tv_basic']=="F") echo " checked" ?>> No
				</td>
			</tr>
			<tr>
				<td colspan="2">AT&T Mobile TV Plus Capable:</td>
				<td>
					<input type="radio" name="at&t_mobile_tv_plus" value="T"<? if ($copy['at&t_mobile_tv_plus']=="T") echo " checked" ?>> Yes
					<input type="radio" name="at&t_mobile_tv_plus" value="F"<? if ($copy['at&t_mobile_tv_plus']=="" || $copy['at&t_mobile_tv_plus']=="F") echo " checked" ?>> No
				</td>
			</tr>
			</table>
		</div>
