...
case "addphone":	// Put a phone in the phones table
	...
	$query =
		...
		'".$_REQUEST['at&t_mobile_backup']."',
		'".$_REQUEST['at&t_smart_limits']."',
		'".$_REQUEST['at&t_mobile_tv_basic']."',
		'".$_REQUEST['at&t_mobile_tv_plus']."');";
//echo $query.'<br></br>';
...
//echo mysql_insert_id($linkID).'<br></br>';
	...
	// Update it
	$query = "UPDATE `phones` SET `product_id` = '".$product_id."' WHERE `unique_id` = '".mysql_insert_id($linkID)."'";
//echo $query.'<br></br>';
