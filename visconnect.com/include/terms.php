...
<tr>
	<td valign="top">
		...
		<tr>
			<td><img src="images/TermsHeader.jpg" alt="" width="710" height="25" border="0"></td>
		</tr>
		<tr>
			<td bgcolor="#FFFFFF" background="images/InfoBG.jpg" style="background-position:top; background-repeat:repeat-y;">
				...
				<tr>
					...
					?>
						<!-- Sprint-Nextel IL -->
						<p>IMPORTANT SERVICE/PRODUCT SPECIFIC TERMS</p>
						...
						<p>SMS Messaging: Unused plan messages do not carry forward. Premium SMS Messages are an additional charge and vary by product. International rates may vary.</p>
					
						<p>Sprint Voice Command: Not available while roaming off the nationwide Sprint PCS network. Calls to 911 or similar emergency numbers cannot be placed through Sprint PCS Voice Command. Dial "911" on your phone in an emergency. Airtime and applicable long-distance charges begin when you press or activate the TALK or similar key.</p>
					
						<p>Sprint Total Equipment Protection<br>
