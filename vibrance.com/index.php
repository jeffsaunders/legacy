...
<head>
	...
	<!-- Set the style for Animated Phrases-->
	<style type="text/css">
		.stHeadliner {
			font-family: serif;
			font-size: large;
...
<body onLoad="javascript:StartHeadliner();">

<table border="0" cellspacing="0" cellpadding="0" align="center">
<tr>
	<td colspan="2"><img src="images/header_welcome.gif" width="700" height="91" alt="" border="0"></td>
</tr>
<tr>
	...
	<td width="533" height="525" align="center" valign="top" background="images/delia_wm.jpg" style="background-position: top; background-repeat: no-repeat;"><img src="images/spacer.gif" width="1" height="70" alt="" border="0"><img src="images/logo4splash2.jpg" alt="" width="533" height="225" border="0" galleryimg="no">
	<!-- Animated Phrases -->
	<SCRIPT LANGUAGE="JavaScript">
	// Set Things Up...
