...
<div id="header">
	...
	<div id="headerSocial">
		<div id="headerFacebook"><a href="http://www.facebook.com/PrayerBelts" target="_blank"><img src="images/facebook.gif"></a></div>
		<div id="headerTwitter"><a href="http://www.twitter.com/PrayerBelts" target="_blank"><img src="images/twitter.gif"></a></div>
		<div id="headerEmail"><a href="mailto:{Your Friend's Email Address}?subject=New Prayer Belts!&body=Hey, check out these cool new Prayer Belts! http://www.prayerbelts.com"><img src="images/friend.gif"></a></div>
	</div>
</div>
<div id="navBar">
	...
	<tr>
		...
		<td width="147" class="navBar"><a href="?sec=products">Our Products</a></td>
...
<!--			<img src="images/image1.jpg" class="active">
			...
			<img src="images/new-photo-1.jpg" class="active">
			<img src="images/new-photo-2.jpg">
			<img src="images/new-photo-3.jpg">
		</div>
	</div>
	<img src="images/ad1.gif" border="0" usemap="#Map1">
	<map name="Map1" id="Map1">
		<area shape="rect" coords="64,215,197,259" href="?sec=about">
	</map>
	<img src="images/ad2.gif" border="0" usemap="#Map2">
	<map name="Map2" id="Map2">
		<area shape="rect" coords="63,215,194,258" href="?sec=products">
	</map>
</div>
...
<div id="contentContainer" style="position:relative;">
	...
	switch($sec){
		...
		case "detail": include("includes/detail.php"); break;
...
<div id="footer">
	...
	<tr>
		...
		<td align="center" class="footerCell"><a href="?sec=products">Our Products</a></td>
