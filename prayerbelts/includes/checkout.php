	...
	<div id="checkoutText">
		...
		<tr>
			<td colspan="6" align="center">
				...
				<input type="submit" name="Submit" id="Submit" value="Proceed to Step 2">
			</td>
		</tr>
		</table>
		</form>
...
?>
	<div id="checkoutTagline">Your are now connected to the First Data Global Gateway Secure Payment System</div>
