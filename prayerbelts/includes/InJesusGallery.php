<!-- BEGIN Include InJesusGallery.php -->
										
<table width="100%" border="0">
<tr>
	<td><img src="images/products/In-JESUS-Name-We-Pray.jpg" alt="" width="400"border="0"></td>
	<td align="right"><a href="javascript:hide('inJesusGallery');javascript:hide('overlayMask');"><img src="images/CloseButton.gif" alt="Close" title="Close" width="25" height="24" border="0"></a></td>
</tr>
</table>
<!-- Flash Gallery -->

<!-- Div that contains gallery. -->
<div id="inJesusFlash" align="center" style="background:transparent;">
...
<script language="javascript" type="text/javascript">
	...
	so.addVariable("content_path","../images/gallery/InJesusName"); // Location of a folder with JPG and PNG files (relative to PHP script).
...
<!-- END Include InJesusGallery.php -->
