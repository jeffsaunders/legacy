<?php
//$XMLFILE = "http://blog.prayerbelts.com/feed/";
//print_r($XMLFILE);
//$TEMPLATE = "rss/blogTemplate.html";
//$MAXITEMS = "-3";
//include("rss/rss2html.php");
?>

		<?
//		$xml = XML_RSS('http://blog.prayerbelts.com/feed/');
...
//	include("rssreader.php");
//	$url="http://www.wired.com/news/feeds/rss2/0,2610,,00.xml";
	$url="http://blog.prayerbelts.com/feed/";
	$rss=new rssFeed($url);
	if($rss->error){
		print "<h1>Error:</h1>\n<p><strong>$rss->error</strong></p>";
	}else{
...
?>
		...
		<div id="blogPosts">
			...
			<div class="blogPost">
				<span class="blogLabel"><?= ?></span>
				~~~ItemDescription~~~...<br>
<!--				<a href="#" class="blogLink" title="Click to Visit Our Blog">More >></a>-->
			</div>
			<div class="blogPost">
