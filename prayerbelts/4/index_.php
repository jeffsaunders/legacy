...
<div id="topSectionBackground" style="position:relative; top:0px; left:0px; width:100%; height:450px; background-color:#FFFFFF; background:transparent url('images/TopSectionBackground.png') repeat-x left top; z-index:0;"></div>
...
<div id="pageContainer" style="position:absolute; top:0px; left:50%; margin-left:-480px; width:960px; min-height:800px;">
<!--	<div id="topLogo" style="position:fixed; top:10px; left:0px; width:350px; height:50px; z-index:10;">-->
...
<!--			<td style="padding:0px 0px 3px 10px;"><a href="./" id="joinMailingList" title="Join Our Mailing List" class="headerBlack"><!--<img src="images/Header-MailingList.png" alt="Join Our Mailing List" title="Join Our Mailing List!" height="20" width="100">--Join Our Mailling List</a></td>-->
		</tr>
		</table>
	</div>
<!--	<div id="topJoinList" align="right" style="position:absolute; top:2px; left:500px; width:200px; height:25px; z-index:11;">-->
...
<!--	<div id="topCart" align="right" style="position:absolute; top:2px; right:10px; width:350px; height:25px; z-index:10;">-->
	<div id="topCart" align="right" style="position:fixed; top:2px; left:50%; margin-left:130px; width:350px; height:25px; z-index:10;">
		...
		<tr onMouseOver="cartIcon.src='images/CartIconOn.png'; document.getElementById('cartContents').style.color='#FFFFFF';" onMouseOut="cartIcon.src='images/CartIcon.png'; document.getElementById('cartContents').style.color='#000000';">
			...
			<td style="padding:0px 0px 3px 10px;"><a href="./" id="cartContents" title="Your Shopping Cart" class="headerBlack"><!--<img src="images/Header-CheckoutCart.png" alt="Checkout|Cart" width="80" height="20" border="0" title="Your Shopping Cart Is Empty">-->Checkout | Cart :&nbsp;&nbsp;<strong>0 Items</strong></a></td>
<!--			<td id="cartContents" style="padding:0px 0px 3px 10px;" class="menuWhite"><strong>0 Items</strong></td>-->
		</tr>
		</table>
	</div>
<!--	<div id="topMenuBackgroundMask" style="position:absolute; top:30px; left:50%; width:50%; height:55px; background:transparent url('images/TopMenuBG.png') repeat left top; z-index:4;"></div>-->
<!--	<div id="topMenu" align="right" style="position:absolute; top:50px; right:10px; width:500px; height:25px; z-index:5;">-->
...
<!--	<div id="splashBelt" style="position:absolute; top:140px; left:10px; width:700px; height:400px; z-index:2;">
		<img src="images/SplashBelt.png" alt="" name="splashBelt" id="splashBelt" width="700" height="400" border="0">
	</div>-->
...
<!--		<img src="images/HomeBelt2.png" alt="" name="splashBelt1" id="splashBelt1" border="0">-->
	</div>
...
<!--	<div id="topSmallBadge" style="position:absolute; top:85px; left:-10px; width:200px; height:200px; z-index:3;">-->
...
<!--		<div id="learnMore" style="position:absolute; top:300px; right:25px; width:140px; height:500px; z-index:4;">-->
	...
	<div id="SocialPostings" style="position:absolute; top:900px; left:50%; margin-left:-480px; width:960px; min-height:750px; z-index:2;">
...
<div id="footerBackground" style="position:absolute; top:1500px; left:0px; width:100%; min-height:200px; background-color:#FFFFFF; z-index:10;">



<!--<div id="Footer" style="position:relative; top:20px; left:0px; width:100%; min-height:200px; background-color:#FFFFFF; z-index:2;">-->
	<div id="FooterContainer" style="position:absolute; top:0px; left:50%; margin-left:-460px; width:940px; z-index:11;">
...
<div id="bottomBarBackground" style="position:absolute; top:1700px; left:0px; width:100%; min-height:25px; background-color:#1F1F1F; text-align:center; padding:8px 0px 0px 0px; z-index:0;">
