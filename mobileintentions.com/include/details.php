...
<!--										<input type="image" src="images/OrderNow.gif" alt="Order your '.$row["manufacturer"].'&nbsp;'.$row["model"].' Now!" width="125" height="25" border="0" onClick="return orderform(form,\'nameprompt\');" onFocus="vanish(\'nameprompt\');">-->
										<a href="https://secure.nr.net/mobileintentions/?sec=order&prod='.$row["product_id"].'"><img src="images/OrderNow.gif" alt="Order your '.$row["manufacturer"].'&nbsp;'.$row["model"].' Now!" width="125" height="25" border="0"></a>
...
<!--										<a href="https://secure.nr.net/mobileintentions/?sec=order&prod='.$row["product_id"].'&zipcode='.$zipcode.'"><img src="images/OrderNow.gif" alt="Order your '.$row["manufacturer"].'&nbsp;'.$row["model"].' Now!" width="125" height="25" border="0"></a>
								...
								<tr>
									<td colspan="2" align="center" class="smallBlack">
							...
							<td width="250" rowspan="2" align="right" valign="bottom">
