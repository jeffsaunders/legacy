	...
	<td align="center" bgcolor="#FFFFFF">
		...
		<tr>
			<td width="100" align="center" valign="top">
				...
				<a href="?sec=details&prod='.$row['product_id'].'" class="smallBlack"><img src="images/phones/'.$row["thumbnail"].'" alt="'.$row["description"].'" width="100" height="120" border="0"><br>
				<strong>Details</strong></a><br>
			...
			<td width="206" valign="top" class="bodyBlack">
				...
				if ($row["mail_in"] != 0){ //There's a mail-in rebate
					echo'
						<tr>
							<td><strong>Instant Savings</strong></td>
							<td align="right">
								<font color="#008000">
...
<!--					<form action="https://secure.nr.net/mobileintentions/"> <!-- Outside of cell for IE formatting -->
				...
				echo'
						<img src="images/spacer.gif" alt="" width="1" height="10" border="0"><br>
						<!-- Order Button -->
<!--						&nbsp;&nbsp;&nbsp;<input type="image" src="images/OrderNow.gif" alt="Order your '.$row["manufacturer"].'&nbsp;'.$row["model"].' Now!" width="125" height="25" border="0" onClick="return orderform(form,\'nameprompt\');" onFocus="vanish(\'nameprompt\');">-->
						<img src="images/spacer.gif" alt="" width="15" height="1" border="0"><a href="https://secure.nr.net/mobileintentions/?sec=order&prod='.$row["product_id"].'&zipcode='.$zipcode.'"><img src="images/OrderNow.gif" alt="Order your '.$row["manufacturer"].'&nbsp;'.$row["model"].' Now!" width="125" height="25" border="0"></a>
<!--						<input type="hidden" name="sec" value="order">
				...
				<tr>
					<td>
						<table border="0" cellspacing="0" cellpadding="0" align="left" class="microBlack">
						<tr>
							<td><img src="images/spacer.gif" alt="" width="20" height="1" border="0"></td>
							<td><strong>Name:</strong></td>
							<td><input type="text" name="name" size="8" maxlength="50" class="microBlack" style="background-color:#FFFFBB;" onFocus="vanish(\'nameprompt\');">&nbsp;&nbsp;</td>
							<td><strong>Email:</strong></td>
							<td><input type="text" name="email" value="" size="8" maxlength="50" class="microBlack" style="background-color:#FFFFBB;" onFocus="vanish(\'nameprompt\');"></td>
						</tr>
						</table>
						</form>
					</td>
...
<!--				<tr>
					<td class="smallBlack">
						...
						<strong>Mobile Intentions Exclusive!</strong><br>
						<strong class="bodyBlack"><font color="#FF0000">FREE ACTIVATION****</font></strong><br>
						<em>(Save an Additional <strong>$35.00</strong> Per Phone)</em><br>
						<img src="images/spacer.gif" alt="" width="1" height="10" border="0"><br>
					</td>
				</tr>-->
				</table>
			...
			$result2 = mysql_query("SELECT * FROM features WHERE product_id = '$prod_id' LIMIT 19", $linkID); //Only room for 15
			for ($counter2=1; $counter2 <= mysql_num_rows($result2); $counter2++){ // Counter loop within a loop, hence counter2
				...
				if ($counter2 == 20){
					echo'	<td width="50%" valign="top"><li><strong title="Too many features to list!"><a href="?sec=details&prod='.$row['product_id'].'" class="smallBlack"><font color="#FF0000">More...</font></strong></a></font></td>';
				}else{
					if ($row2["feature"]){
	...
	<td width="100%" bgcolor="#FFFFFF">
		...
		<tr>
			...
			<td width="140" align="right" valign="top">
				<img src="images/spacer.gif" alt="" width="1" height="40" border="0"><br>
