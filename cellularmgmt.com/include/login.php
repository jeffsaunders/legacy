	...
	<td width="700">
		...
		<tr>
			<td align="center">
				...
				<form action="dbaccess.php" method="get" name="login" id="login" onSubmit="return validate(this);">
...
?>
		...
		<tr>
			<td align="center" valign="bottom" class="smallGray">
				<br><br>
...
<script>
if (readCookie('user')) login.username.value = readCookie('user');
if (readCookie('pass')) login.password.value = readCookie('pass');
</script>
