...
// make rev a & b versions of some of these ("your" vs. "their", etc.) and call based on user_level
		...
		help[3] = '<strong>Administrator Options</strong> &mdash;<br>Place bulk orders, approve restricted requests, manage devices, edit site notes, administer site users, run reports, etc.';
			...
			help[305] = '<strong>Approve Requests</strong> &mdash;<br>Approve requests submitted by users.';
	...
	<? if ($_SESSION["user_level"] == "Asst" || $_SESSION["user_level"] == "Admin"){ ?>
				<tr>
					<td height="20" class="bodyBlack">
						<img src="images/spacer.gif" alt="" width="10" height="1" border="0">
						<img src="images/PurpleBullet.gif" alt="" width="10" height="10" border="0">
						<strong>&nbsp;<a href="?sec=ticket&task=list_approvals" onmouseOver="showHelp(305);" onmouseOut="showHelp(0);" class="bodyBlackGreen">Approve Requests</a></strong>
					</td>
				</tr>
	<? } ?>
	<? if ($_SESSION["user_level"] == "Asst" || $_SESSION["user_level"] == "Admin"){ ?>
	...
	<? if ($_SESSION["user_level"] == "Admin"){ ?>
				<tr>
					<td height="20" class="bodyBlack">
						<img src="images/spacer.gif" alt="" width="10" height="1" border="0">
						<img src="images/GreenBullet.gif" alt="" width="10" height="10" border="0">
						<strong>&nbsp;<a href="?sec=reports" onmouseOver="showHelp(310);" onmouseOut="showHelp(0);" class="bodyBlackGreen">Reports</a></strong>
					</td>
				</tr>
	<? } ?>
				</table>
   	...
   	<div id="menu4" z-index: 0;>
		...
		<tr bgcolor="#EFEFEF">
			...
			<td	width="240"
				...
				class="bodyBlack"
				style="cursor:pointer;">
				<strong id="text4-1"><img src="images/spacer.gif" alt="" width="5" height="1" border="0">News &amp; Site Notes</strong>
			</td>
		</tr>
		</table>
	</div>
...
<div align="right"><img src="images/GoogleArt.gif" alt="" width="143" height="53" border="0"></div>
