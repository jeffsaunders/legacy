...
// The main part of the script:
	...
	// Costa Rica
		...
		CostaRica.setHours(CostaRica.getHours()-6) // Temporarily fool system into thinking it's on CR time.  Need to mkae this smarter to handle DST better...-5 vs. -6 hours.
	...
	// Set up the hours for either 24 or 12 hour display:
		if (my12_hour) {
			...
			if (hours == 0) { hours = 12; }
			if (crhours > 11) { crdn = "PM"; crhours = crhours - 12; }
