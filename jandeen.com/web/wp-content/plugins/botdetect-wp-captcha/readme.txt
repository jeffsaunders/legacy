...
BotDetect Captcha plugin is a powerful captcha protection for WordPress login, lost password, registration, and comment forms.
...
* Full support for all Android & iOS & BlackBerry devices
...
Your contribution to BotDetect WP Captcha Plugin localization efforts is very welcome. Just send us the language pack PO and MO files created with Poedit, and we'll add them to BotDetect WP Captcha Plugin plugin source trunk -- with a thank you note of course :)
...
This Plugin uses BotDetect PHP Captcha library to generate captcha challenges. BotDetect PHP Captcha library will be downloaded from captcha.com site. 

Procedure is fully automated and straightforward. Before download you will be asked to enter your (or some temporary) email that will be used as your identification (used for upgrading, updating and support) at captcha.com.
...
[Contact BotDetect WordPres Captcha plugin developers](http://captcha.com/contact.html)
...
= 3.0.Beta3.2 =
* UPDATE: Improved BotDetect WP Captcha Plugin backwards compatibility management
* UPDATE: Improved BotDetect PHP Captcha Library installation procedure
* UPDATE: Improved user friendliness of BotDetect WP Captcha Plugin error messages
* NEW: Added support for BotDetect WP Captcha Plugin localization
* NEW: Added Vietnamese localization of the BotDetect WP Captcha Plugin UI 

= 3.0.Beta3.1 =
* BUGFIX: Fixed the issue with BotDetect WP Captcha Plugin preventing tags adding into posts while enabled
* BUGFIX: Fixed the issue with BotDetect WP Captcha Plugin preventing media adding into posts while enabled
* BUGFIX: Fixed the issue with broken saving of Captcha and BotDetect WP Captcha Plugin settings
...
= 3.0.Beta1.7 =
* UPDATE: Fixed the user interface option related to Comments Captcha, which was not correct for all BotDetect WP Captcha Plugin versions since version 3.0.Beta1.4
...
= 3.0.Beta1.3 =
* UPDATE: BotDetect WP Captcha Plugin options are spellchecked now :)

= 3.0.Beta1.2 =
* BUGFIX: Fixed the "you do not have enough permissions" bug on BotDetect WP Captcha Plugin plugin activation

= 3.0.Beta1.1 =
* UPDATE: Minor BotDetect WP Captcha Plugin options change

= 3.0.Beta1.0 =
* UPDATE: Fixed BotDetect WP Captcha Plugin versioning issues
