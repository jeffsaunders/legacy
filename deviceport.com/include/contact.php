...
<tr>
	...
	<!-- Step Label -->
		...
		<tr>
			<td>
				<br><br>
				<strong><u><? echo $contact_name; ?></u></strong><br><br>
				<ul>
					<li><? echo $contact_address; ?><br>
					<? if ($contact_phone != "") {echo "Phone: <strong>".$contact_phone."</strong><br>";} ?>
					<? if ($contact_fax != "") {echo "Fax: <strong>".$contact_fax."</strong><br>";} ?>
					<? if ($contact_tollfree != "") {echo "Toll-Free: <strong>".$contact_tollfree."</strong><br>";} ?>
					<? if ($contact_email != "") {echo "Email: <a href='mailto:".$contact_email."' class='bodyBlack'><strong>".$contact_email."</strong></a><br>";} ?>
					<? if ($contact_url != "") {echo "Website: <a href=\"http://".$contact_url."\" target=\"_blank\" onmouseover=\" window.status='Click Here To Visit ".$familiar_name."!'; return true\" onmouseout=\"window.status=''; return true\" class=\"bodyBlack\"><strong>".$contact_url."</strong></a><br>";} ?>
					</li><br>
...
?>
				<br><strong><u>Sprint</u></strong><br><br>
				<ul>
<!--					<li>To request a company sponsored discount be applied to your individual Sprint account, go to: <a href="javascript:SpawnChild('http://www.sprint-discount.com','child','790','600','yes','','','','','1','1','1','1','1');" child.focus();" onmouseover=" window.status='Click Here For Your Discount!'; return true" onmouseout="window.status=''; return true" class="bodyBlack"><strong>www.sprint-discount.com</strong></a>.<br></li><br>-->
					<li>To request a company sponsored discount be applied to your individual Sprint account, go to: <a href="http://www.sprint-discount.com" target="_blank" onmouseover=" window.status='Click Here For Your Discount!'; return true" onmouseout="window.status=''; return true" class="bodyBlack"><strong>www.sprint-discount.com</strong></a>.<br></li><br>
