...
?>
	...
	//			document.PlanForm.IMEI.value = "";
		...
		<!-- Step Label -->
			...
			<tr>
				<td class="superbigBlack">Activate with <? echo $activator_name; ?></td>
			</tr>
			</table>
	...
	?>
			<div id="EnterPassword" style="position:static; visibility:visible; display:block;">
				...
				<tr>
					<td class="bigBlack">Please Log In for Access:</td>
				</tr>
				<tr>
					<td align="center">
						<br>
						...
						<tr>
							...
							<td><input type="text" name="username" size="20" maxlength="25" value="aircell"></td>
							<td><img src="images/spacer.gif" alt="" width="10" height="1" border="0"></td>
							<td class="bigBlack">Password:</td>
							<td><input type="password" name="password" size="20" maxlength="25" value="skyfi"></td>
						</tr>
						<tr>
	...
	?>
			<div id="WelcomeMessage" style="position:static; visibility:visible; display:block;">
				...
				<table width="900" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td class="superbigBlack"><? echo $welcome_headline; ?></td>
				</tr>
				<tr>
				...
				<tr>
					<td height="30" valign="top" class="bigBlack">
						...
						&nbsp;<input type="button" value="Go" onClick="checkQuantity();" disabled>
							';
							if ($excel_upload == "T") echo'&nbsp;or&nbsp;&nbsp;<input type="button" value="Upload Spreadsheet" style="width:140px;" onClick="popUpload();" disabled>';
						}else{
							echo'
						...
						&nbsp;<input type="button" value="Go" onClick="checkQuantity();">
							';
							if ($excel_upload == "T") echo'&nbsp;or&nbsp;&nbsp;<input type="button" value="Upload Spreadsheet" style="width:140px;" onClick="popUpload();">';
						}
						?>
						</div>
					</td>
...
//						window.location="http://<? echo $site; ?>.deviceport.com/?sec=activate&step=select&site=<? echo $site; ?>&AddVoicePlan=No&sid=<? echo $_REQUEST['sid']; ?>";
				...
				<tr>
					<td width="900">
						...
						<tr bgcolor="<? echo $border_bgcolor; ?>" class="bodyWhite">
							<td height="25" width="50" align="center">Device</td>
							<td width="100" align="center">ESN HEX</td>
				...
				<td>
					...
					<tr>
						<td width="800" valign="top">
							...
							<tr>
								<td valign="top" class="superbigBlack">Activate with <? echo $activator_name; ?></td>
							</tr>
							<tr>
...
<!--							<form action="https://secure.nr.net/deviceport/" method="post" name="EditDevices" id="EditDevices">-->
							<form action="http://aircell.deviceport.nr.net/" method="post" name="EditDevices" id="EditDevices">
								<input type="hidden" name="sec" id="sec" value="activate">
		...
		<!-- Step Label -->
			...
			<tr>
				<td>
					<table width="900" border="0" cellspacing="0" cellpadding="0" align="center">
					<tr>
						<td valign="top" class="xbigBlack">Thank You for Activating with <? echo $activator_name; ?></td>
					</tr>
					<tr>
