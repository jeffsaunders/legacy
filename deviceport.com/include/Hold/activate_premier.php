						...
						<tr>
							...
							for ($counter=1; $counter <= mysql_num_rows($rs_plans); $counter++){
								...
								<tr bgcolor="'.$box_bgcolor.'" onMouseOver="show(\'Plan'.$row["plan_id"].'Div\');" onMouseOut="hide(\'Plan'.$row["plan_id"].'Div\');" class="bodyBlack">
									<td height="25" align="left" style="padding-left: 5px">
										<div id="container" style="position:relative; align:left; z-index:0; display:block;">
											<div id="Plan'.$row["plan_id"].'Div" style="position:absolute; top:-16; left:50; z-index:1; width:400px; background-color:#FFFFFF; border: thin solid '.$border_bgcolor.'; padding:5px; visibility:hidden">
												<table width="100%" border="0" cellspacing="0" cellpadding="0" class="smallBlack">
												<tr>
													<td><strong>'.$row["plan_name"].'</strong></td>
												</tr>
...
//		}
		<?
//			if ($order['add_line'] == "No" && $order['acct_type'] == "CL"){
			if ($order['add_line'] == "No"){
		?>
		// Verify Account Password
		if (theForm.password){
			var pin_regex = /^[1-9]\d{5}$/;  // (xxx)xxx-xxxx
...
<!--							<tr>
							...
							<tr bgcolor="<? echo iif(is_even($rowcount), $roweven, $rowodd); ?>">
								...
								<td>
									...
									<tr>
										<td width="650">
											<input type="text" name="company_name" id="company_name" size="75" maxlength="100" tabindex="4" class="bodyBlack" style="width:494px; background-color: <? echo $form_bg; ?>" value="<? echo $order['company_name']; ?>">
										</td>
									</tr>
									</table>
								</td>
...
//										}
							...
							?>
							<tr bgcolor="<? echo iif(is_even($rowcount), $roweven, $rowodd); $rowcount++; ?>">
								<td align="right" valign="top" class="xbigBlack"><img src="images/spacer.gif" alt="" width="1" height="3" border="0"><br><? echo $carrier; ?> Password/PIN:</td>
								<td>
									<table border="0" cellspacing="5" cellpadding="0" class="bodyBlack">
									<tr>
										<td width="650" valign="top">
											<input type="text" name="password" id="password" size="30" maxlength="6" tabindex="7" onKeyPress="return onlyNumbers(event,this);" class="bodyBlack" style="width:200px; background-color: <? echo $form_bg; ?>;" value="<? echo $order['password']; ?>"><span class="smallBlack"> *Must be a Six Digit Number<br>Enter Desired Password/PIN</span></td>
									</tr>
									</table>
								</td>
							</tr>
							...
							<tr bgcolor="<? echo iif(is_even($rowcount), $roweven, $rowodd); $rowcount++; ?>">
								...
								<td>
									<table border="0" cellspacing="5" cellpadding="0" class="bodyBlack">
									<tr>
										<td width="195" valign="top"><input type="text" name="wireless_phone" id="wireless_phone" size="30" maxlength="50" tabindex="6" class="bodyBlack" style="width:200px; background-color: <? echo $form_bg; ?>;" value="<? echo $order['wireless_phone']; ?>"><span class="smallBlack"><br><? echo iif($order['carrier'] == "verizon", "Any Active  Number on This Account", "Primary Number for This Account"); ?></span></td>
										<td width="605" valign="top" class="xbigBlack"><img src="images/spacer.gif" alt="" width="15" height="1" border="0">Acct#:<img src="images/spacer.gif" alt="" width="15" height="1" border="0"><input type="text" name="acct_number" id="acct_number" size="30" maxlength="50" tabindex="7" class="bodyBlack" style="width:200px; background-color: <? echo $form_bg; ?>;" value="<? echo $order['acct_number']; ?>"><? echo iif($carrier == 'Verizon', '<span class="smallBlack"> *Required</span>', '<span class="smallBlack"> *Enter Either or Both</span>'); ?></td>
									</tr>
									<tr>
										<?
										if ($order['add_line'] == "No"){
										?>
										<td colspan="2" class="xbigBlack"><img src="images/spacer.gif" alt="" width="47" height="1" border="0">Requested Password/PIN:<img src="images/spacer.gif" alt="" width="15" height="1" border="0"><input type="text" name="password" id="password" size="30" maxlength="50" tabindex="8" class="bodyBlack" style="width:200px; background-color: <? echo $form_bg; ?>;" value="<? echo $order['password']; ?>"><span class="smallBlack"> *Optional</span></td>
										<?
										}else{
										?>
										<td colspan="2" class="xbigBlack"><img src="images/spacer.gif" alt="" width="71" height="1" border="0">Account Password/PIN:<img src="images/spacer.gif" alt="" width="15" height="1" border="0"><input type="text" name="password" id="password" size="30" maxlength="50" tabindex="8" class="bodyBlack" style="width:200px; background-color: <? echo $form_bg; ?>;" value="<? echo $order['password']; ?>"><? echo iif($carrier == 'Sprint', '<span class="smallBlack"> *Required</span>', '<span class="smallBlack"> *If Applicable</span>'); ?></td>
										<?
										}
										?>
									</tr>
...
<!--					<tr>
					...
					<tr>
						<td>
							<table width="100%" border="0" cellspacing="0" cellpadding="5" align="center" class="borderNone">
							<tr bgcolor="<? echo iif(is_even($rowcount), $roweven, $rowodd); $rowcount++; ?>">
								<td width="225" align="right" valign="top" class="xbigBlack"><img src="images/spacer.gif" alt="" width="1" height="3" border="0"><br>Sales Representative:</td>
								<td width="675">
									<table border="0" cellspacing="5" cellpadding="0" class="bodyBlack">
									<tr>
										<td>
											<select name="sales_rep" id="sales_rep" tabindex="75" class="bodyBlack" style="width:200px; background-color: <? echo $form_bg; ?>;">
												<option value="">Select</option>
												<?
							...
							?>
							<tr bgcolor="<? echo iif(is_even($rowcount), $roweven, $rowodd); $rowcount++; ?>">
								<td width="225" align="right" valign="top" class="xbigBlack"><img src="images/spacer.gif" alt="" width="1" height="3" border="0"><br>Shipping Options:</td>
								<td width="675">
									<table border="0" cellspacing="5" cellpadding="0" class="bodyBlack">
									<tr>
										<td>
											<select name="shipping" id="shipping" tabindex="78" class="bodyBlack" style="width:200px; background-color: <? echo $form_bg; ?>;">
												<option value="">Select</option>
												<?
//												for ($counter=1; $counter <= mysql_num_rows($rs_reps); $counter++){
//													$rep = mysql_fetch_assoc($rs_reps);
...
//												}
							...
							?>
							<tr bgcolor="<? echo iif(is_even($rowcount), $roweven, $rowodd); $rowcount++; ?>">
								<td align="right" valign="top" class="xbigBlack"><img src="images/spacer.gif" alt="" width="1" height="3" border="0"><br>Additional Information:</td>
								<td>
									<table border="0" cellspacing="5" cellpadding="0" class="bodyBlack">
									<tr>
										<td>
											<textarea name="notes" id="notes" tabindex="80" rows="4" cols="85" class="bodyBlack" style="width:400px;">
				...
				<td align="center">
					...
					<tr>
						<td align="center">
							...
							?>
							<tr bgcolor="<? echo iif(is_even($rowcount), $roweven, $rowodd); $rowcount++; ?>">
								<td align="right" valign="top">Tax ID (FEIN/TIN):</td>
...
<!--								<tr bgcolor="'.$box_color.'" style="background-image:url(images/ButtonBarBG.jpg);" class="bodyWhite">-->
					...
					<tr>
						<td colspan="2" align="center">
							<form action="" method="post" name="EditDevices" id="EditDevices">
								<input type="hidden" name="sec" id="sec" value="activate">
		...
		<!-- Step Label -->
			...
			<tr>
				<td>
					<table width="900" border="0" cellspacing="0" cellpadding="0" align="center">
					<tr>
						<td valign="top" class="xbigBlack">Thank You for Activating with PWS</td>
					</tr>
					<tr>
...
<!-- END Include activate_premier.php -->
