...
<tr>
	<td width="199" align="center" valign="bottom" background="images/<? echo $tab; ?>" class="<? echo $tab_class; ?>"><strong>Rebates</strong></td>
	...
	<td colspan="2" bgcolor="#FFFFFF" style="border-left: 1px solid <? echo $border_color; ?>; border-right: 1px solid <? echo $border_color; ?>;">
		...
		<tr>
			...
			<td class="bodyBlack">
				<div align="center">
				<br>
				<strong class="xbigBlack">There are currently no rebates available.</strong><br>
				</div>
			</td>
			<td width="20"><img src="images/spacer.gif" alt="" width="20" height="1" border="0"></td>
		</tr>
