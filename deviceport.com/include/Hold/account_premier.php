...
<!--				<tr>
				...
				?>
				<tr bgcolor="<? echo iif(is_even($rowcount), $roweven, $rowodd); $rowcount++; ?>">
					<td width="250" align="right" valign="top" class="xbigBlack"><img src="images/spacer.gif" alt="" width="1" height="3" border="0"><br>Authorized Order Placer:<? echo iif($order['add_line'] == "No", '<br><span class="smallBlack"><a href="javascript:CopyContact();" class="smallBlack" style=" text-decoration:underline;">Click to Copy Billing Contact Here</strong></a></span>', ''); ?></td>
					<td width="650">
						<table border="0" cellspacing="5" cellpadding="0" class="bodyBlack">
						<tr>
							<td colspan="2">
								<input type="text" name="order_placer_name" id="order_placer_name" size="30" maxlength="100" tabindex="29" class="bodyBlack" style="width:405px; background-color: <? echo $form_bg; ?>" value="<? echo $order['order_placer_name']; ?>">
							</td>
						</tr>
						<tr>
							<td width="195"><input type="text" name="order_placer_phone" id="order_placer_phone" size="19" maxlength="25" tabindex="30" class="bodyBlack" style="width:200px; background-color: <? echo $form_bg; ?>;" value="<? echo $order['order_placer_phone']; ?>"><br><span class="smallBlack">Phone Number</span></td>
							<td width="605" valign="top" class="xbigBlack"><input type="text" name="order_placer_email" id="order_placer_email" size="50" maxlength="50" tabindex="31" class="bodyBlack" style="width:200px; background-color: <? echo $form_bg; ?>;" value="<? echo $order['order_placer_email']; ?>"><br><span class="smallBlack">Email</span></td>
						</tr>
						</table>
					</td>
				</tr>

<!-- add copy order contact feature, title, yrs in biz-->
