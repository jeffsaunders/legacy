...
//						window.location="http://<? echo $site; ?>.deviceport.com/?sec=activate&step=select&site=<? echo $site; ?>&AddVoicePlan=No&sid=<? echo $_REQUEST['sid']; ?>";
				...
				<tr>
					<td class="bigBlack">
						<ul>
							...
							<ul>
								<input type="radio" name="AddVoicePlan" value="Yes" onClick="addVoice();"<? echo iif($_REQUEST['AddVoicePlan'] == "Yes", " checked", ""); ?>> Yes, I would like to add a Voice Plan to <? echo iif($order['device_count'] > 1, "at least one of the devices", "the device"); ?> I am activating.<br>
								<input type="radio" name="AddVoicePlan" value="No" onClick="addVoice();"<? echo iif(!$_REQUEST['AddVoicePlan'] || $_REQUEST['AddVoicePlan'] == "No", " checked", ""); ?>> No, I just want to select a Data Plan for the device<? echo iif($order['device_count'] > 1, "s", ""); ?> I am activating.<br>
							</ul>
						</ul>
					</td>
				</tr>
				...
				<tr>
					<td width="900">
						...
						<div id="CDMADataOnly" style="position:static; visibility:<? echo iif((!$_REQUEST['AddVoicePlan'] || $_REQUEST['AddVoicePlan'] == "No"), 'visible;', 'hidden; display:none;'); ?>">
	...
	<!--						<td align="center"><input type="text" name="ESN<? echo $counter; ?>a" id="ESN<? echo $counter; ?>a" size="8" maxlength="8" style="width:80px; background-color:<? echo $form_bg; ?>;" onKeyUp="if (this.value.length == 8){return checkESN('<? echo $counter; ?>');};" onChange="checkESN('<? echo $counter; ?>');" value=""> <!-- 4 hex digits (8 char.) --</td>-->
						...
						<div id="CDMADataVoice" style="position:static; visibility:<? echo iif($_REQUEST['AddVoicePlan'] == "Yes", 'visible;', 'hidden; display:none;'); ?>">
								...
								<tr>
									...
									<td align="center" bgcolor="<? echo $box_bgcolor; ?>" class="bodyBlack">
										<select name="VoicePlanID<? echo $counter; ?>b" id="VoicePlanID<? echo $counter; ?>b" class="bodyBlack" style="width:564px; background-color: <? echo $form_bgcolor; ?>;" onChange="popVoicePlans('<? echo $counter; ?>','<? echo $order['device_count']; ?>','b');">
											<option value="">Select</option>
											<option value="None">No Voice Plan for This Device</option>
									<?
...
//						window.location="http://<? echo $site; ?>.deviceport.com/?sec=activate&step=select&site=<? echo $site; ?>&AddVoicePlan=No&sid=<? echo $_REQUEST['sid']; ?>";
				...
				<tr>
					<td width="900">
						...
						<div id="GSMDataOnly" style="position:static; visibility:<? echo iif((!$_REQUEST['AddVoicePlan'] || $_REQUEST['AddVoicePlan'] == "No"), 'visible;', 'hidden; display:none;'); ?>">
...
//							getSIMs();
						...
						<div id="GSMDataVoice" style="position:static; visibility:<? echo iif($_REQUEST['AddVoicePlan'] == "Yes", 'visible;', 'hidden; display:none;'); ?>">
