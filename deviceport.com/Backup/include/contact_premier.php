		...
		<tr>
			<td>
				...
				<ul>
					...
					<br>
					<li>For help with online orders call: <strong>877.351.1658</strong> or email: <a href="mailto:<? echo $support_email; ?>" class="bodyBlack"><? echo $support_email; ?></strong></a><br></li><br>
				</ul>
