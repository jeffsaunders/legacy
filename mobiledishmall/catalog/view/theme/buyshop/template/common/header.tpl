...
@font-face {
  ...
  font-style: normal;
  font-weight: 400;
  src: local('Oswald Regular'), local('Oswald-Regular'), url('<?php echo $base; ?>catalog/view/theme/buyshop/font/-g5pDUSRgvxvOl5u-a_WHw.woff') format('woff');
}
@font-face {
  font-family: 'Oswald';
  font-style: normal;
  font-weight: 700;
  src: local('Oswald Bold'), local('Oswald-Bold'), url('<?php echo $base; ?>catalog/view/theme/buyshop/font/bH7276GfdCjMjApa_dkG6T8E0i7KZn-EPnyo3HZu7kw.woff') format('woff');
}
</style>
<?php endif; ?>
...
/* Footer: Background Color  */
        <?php if (!empty($theme_colors["footer_bgcolor"]) ) : ?>
            ...
            #footer_line.footer_line_normal_bg .footer_light_skin_wrapper{background-color: <?php echo $theme_colors["footer_bgcolor"]?> !important}
        <?php endif; ?>
            ...
            <div class="pull-right addit_wrapper">
                <div class="alignright top_panel_left_blocks">
                            <span class="login_social">
                                ...
                                <?php } else { ?>
                                <?php echo '<span class="logout_block" style="font-weight:bold;">'.$text_logged.'</span>'; ?>
                                <?php } ?>
                            </span>
                    <div class="fadelink fadelink_links">
                        <a style="border-color:#333333 !important;"><?php echo $text_account; ?></a>
