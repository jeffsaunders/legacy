<!-- BEGIN Include changeuser.php -->

<?
$tab_label = "Corporate User Change";
$message = "Please enter the following information to allocate an existing corporate line of service to a new corporate user:";
	...
	<td colspan="2" align="center" bgcolor="#FFFFFF" style="border-left: 1px solid <? echo $border_color; ?>; border-right: 1px solid <? echo $border_color; ?>;">
		...
		<tr>
			...
			<td>
				...
				<tr>
					<td colspan="3" class="smallBlack" style="border-bottom: 1px solid #000000;"><br><br><strong>New User Information</strong></td>
				</tr>
				<tr>
				...
				<tr>
					<td align="right">New User First Name:</td>
					<td><input type="text" name="first_name" id="first_name" value="" size="50" maxlength="50" style="width:300px;"></td>
				</tr>
				<tr>
					<td align="right">New User Last Name:</td>
					<td><input type="text" name="last_name" id="last_name" value="" size="50" maxlength="50" style="width:300px;"></td>
				</tr>
				<tr>
					<td align="right">New User Employee ID:</td>
					<td><input type="text" name="employee_id" id="employee_id" value="" size="50" maxlength="50" style="width:300px;"><span class="smallBlack">&nbsp;<em>*Optional</em></span></td>
				</tr>
				<tr>
					<td align="right">New User Cost Center:</td>
					<td><input type="text" name="cost_center" id="cost_center" value="" size="50" maxlength="50" style="width:300px;"><span class="smallBlack">&nbsp;<em>*Optional</em></span></td>
				</tr>
				<tr>
					<td align="right">New User Email Address:</td>
