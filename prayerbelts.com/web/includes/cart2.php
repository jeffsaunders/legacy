...
<div id="cart">
	...
	<div id="cartContents">
		...
		<tr>
			<td colspan="4" align="right"><strong>Total (plus applicable sales tax):</strong><br><div class="detailFootnote" style="padding-top:10px;">* Prayer Belts collects 8¼% Sales Tax on all orders shipped within Texas.  </div></td>
