...
<div id="cart">
	...
	<div id="cartContents">
		...
		<tr>
			<td colspan="4" align="right"><strong>Total (plus applicable sales tax):</strong><br><div class="detailFootnote" style="padding-top:10px;">* Prayer Belts collects 8&frac14;% Sales Tax on all orders shipped within Texas.&nbsp;&nbsp;</div></td>
			<td align="right" valign="top"><strong style="font-size:18px;">$<?=number_format($subtotal + (ceil($qty/$config['shipping']['increment']) * $config['shipping']['cost']), 2, '.', ',');?></strong></td>
		</tr>
		<!-- Seperator -->
		<tr>
			<td colspan="5"><hr width="100%" size="2" color="#F0F0F0"></td>
	...
	<div id="cartContents">
		...
		<tr>
			<td align="center"><strong>&ndash; Your Shopping Cart is Empty &ndash;</strong></td>
		</tr>
		</table>
		<br><br>
	</div>
