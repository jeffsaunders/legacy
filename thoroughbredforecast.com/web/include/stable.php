...
<tr>
	<td class="bodyBlack">
		...
		<tr>
			...
			<td align="right" style="position:relative;"><img src="images/CarsonsCopperBath.jpg" alt="" width="160" height="213" border="1"></td>
		</tr>
		<tr>
			<td height="40" valign="top" class="cellXLtGray" style="padding:2px; border:thin solid black;">
				<strong class="smallBlack">
					Carson's Copper in the pool<br>preparing for his return.
				</strong>
			</td>
		</tr>
		</table>
		...
		<tr>
			<td valign="top">
				...
				<tr>
					...
					<td class="cellBlack"><img src="images/spacer.gif" alt="" width="500" height="1" border="0"><br></td>
					<td rowspan="5" class="cellBlack"><img src="images/spacer.gif" alt="" width="1" height="290" border="0"></td>
				</tr>
				<tr>
					<td width="500" height="330" valign="top"><a onClick="window.open(image.src, '_blank');" style="cursor:pointer;" title="Click To Enlarge"><img src="images/SixyEddie1.jpg" alt="Click To Enlarge" name="image" id="image" width="500" height="330" border="0" galleryimg="no"></a></td>
				</tr>
				<tr>
					<td class="cellBlack"><img src="images/spacer.gif" alt="" width="500" height="1" border="0"><br></td>
				</tr>
				<tr>
					<td height="40" valign="top" class="cellXLtGray" style="padding:2px;">
						<strong name="caption" id="caption">
							Sixy Eddie Gate Training.
						</strong>
					</td>
				</tr>
				<tr>
			...
			<td align="right" valign="top">
				...
				<tr>
					<td align="center"><img src="images/SixyEddie1.jpg" alt="" width="120" height="80" border="1" onMouseOver="flipIt(this.src, 'Sixy Eddie Gate Training.');"></td>
					<td rowspan="10"><img src="images/spacer.gif" alt="" width="14" height="1" border="0"></td>
					<td align="center"><img src="images/SixyEddie2.jpg" alt="" width="120" height="80" border="1" onMouseOver="flipIt(this.src, 'Sixy Eddie Gate Training.');"></td>
				<tr>
					<td colspan="3"><img src="images/spacer.gif" alt="" width="1" height="15" border="0"></td>
				</tr>
				<tr>
					<td align="center"><img src="images/SixyEddie6.jpg" alt="" width="120" height="80" border="1" onMouseOver="flipIt(this.src, 'Sixy Eddie Gate Training.');"></td>
					<td align="center"><img src="images/SixyEddie8.jpg" alt="" width="120" height="80" border="1" onMouseOver="flipIt(this.src, 'Sixy Eddie Gate Training.');"></td>
				<tr>
					<td colspan="3"><img src="images/spacer.gif" alt="" width="1" height="15" border="0"></td>
				</tr>
				<tr>
					<td align="center"><img src="images/SaratogasExcess1.jpg" alt="" width="120" height="80" border="1" onMouseOver="flipIt(this.src, 'Saratoga\'s Excess Gate Training.');"></td>
					<td align="center"><img src="images/SaratogasExcess3.jpg" alt="" width="120" height="80" border="1" onMouseOver="flipIt(this.src, 'Saratoga\'s Excess Gate Training.');"></td>
				<tr>
					<td colspan="3"><img src="images/spacer.gif" alt="" width="1" height="15" border="0"></td>
				</tr>
				<tr>
					<td align="center"><img src="images/SaratogasExcess4.jpg" alt="" width="120" height="80" border="1" onMouseOver="flipIt(this.src, 'Saratoga\'s Excess Gate Training.');"></td>
					<td align="center"><img src="images/SaratogasExcess5.jpg" alt="" width="120" height="80" border="1" onMouseOver="flipIt(this.src, 'Saratoga\'s Excess Gate Training.');"></td>
				<tr>
	...
	<td>
		...
		<tr>
			<td width="300" valign="top" class="bodyBlack">
				...
				<tr>
					<td width="300" height="225" valign="top"><a href="images/CarsonsCopperWinnersCircle.jpg" target="_blank"><img src="images/CarsonsCopperWinnersCircleSmall.jpg" alt="Click To Enlarge" title="Click To Enlarge" name="image2" id="image2" width="300" height="225" border="0" galleryimg="no"></a></td>
				</tr>
				<tr>
					<td class="cellBlack"><img src="images/spacer.gif" alt="" width="300" height="1" border="0"><br></td>
				</tr>
				<tr>
					<td height="65" valign="top" class="cellXLtGray" style="padding:2px;">
						<strong name="caption2" id="caption2">
